...
char* func_35(char* sParam0) // Position - 0x2B93 (11155)
{
	return sParam0;
}
...
void func_42(ePedComponentType epctParam0, char* sParam1, int iParam2, int iParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17) // Position - 0x3262 (12898)
{
	int num;
	int i;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xE387 (58247)
{
...
int func_112(Ped pedParam0) // Position - 0xEE8C (61068)
{
	int i;
