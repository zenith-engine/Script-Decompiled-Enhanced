...
int func_17(BOOL bParam0) // Position - 0x38D3 (14547)
{
	switch (bParam0)
	{
		case false:
...
BOOL func_47(Vehicle veParam0) // Position - 0x4DA3 (19875)
{
	if (PLAYER::PLAYER_ID() != _INVALID_PLAYER_INDEX())
	{
		...
		if (func_51(PLAYER::PLAYER_ID(), true, false) && Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_36 > PV_COMP_HEAD || IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_34, 14) || IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_34, 11))
			return false;
...
ePedComponentType func_49() // Position - 0x4EB5 (20149)
{
...
BOOL func_54() // Position - 0x4F7D (20349)
{
...
BOOL func_66(ePedComponentType epctParam0) // Position - 0x5BCC (23500)
{
...
BOOL func_67(ePedComponentType epctParam0, BOOL bParam1, int iParam2) // Position - 0x5D8A (23946)
{
	int i;
	Hash outData;
...
BOOL func_68(ePedComponentType epctParam0) // Position - 0x5F0F (24335)
{
	int num;
	var unk;
	var name;
...
BOOL func_70(ePedComponentType epctParam0, int iParam1) // Position - 0x5FF2 (24562)
{
	int cloudTimeAsInt;
	int num;
	int i;
