...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0xB9E (2974)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0xBB4 (2996)
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xCE0 (3296)
{
...
void func_129(var uParam0, int iParam1, int iParam2, ePedComponentType epctParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x1BA9E (113310)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
...
void _CONTEXT_REMOVE_HELP_TEXT(var uParam0) // Position - 0x1BD06 (113926)
{
	int num;
