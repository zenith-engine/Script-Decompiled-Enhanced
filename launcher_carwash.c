...
BOOL func_1(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, eStackSize essParam5) // Position - 0x196 (406)
{
	int i;
...
int func_2(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x8D8 (2264)
{
...
void func_3(Vehicle veParam0) // Position - 0x92F (2351)
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_4(BOOL bParam0, BOOL bParam1) // Position - 0x95B (2395)
{
...
int _GET_VEHICLE_SEAT_PED_IS_IN(Ped ped, BOOL includeLastVehicle) // Position - 0xAAC (2732)
{
	Vehicle vehiclePedIsIn;
...
BOOL func_6(BOOL bParam0) // Position - 0xB31 (2865)
{
	if (bParam0)
		if (func_8())
			return true;
...
BOOL func_7(int iParam0) // Position - 0xB57 (2903)
{
	return Global_44199 == iParam0;
}

BOOL func_8() // Position - 0xB65 (2917)
{
	if (Global_113104)
		return true;
...
void func_9() // Position - 0xB97 (2967)
{
	Global_23848.f_6 = 1;
	return;
}

BOOL func_10(var uParam0) // Position - 0xBA5 (2981)
{
	var entityRotation;
	Ped vehiclePedIsIn;
	Ped ped;
...
float func_11(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xC4E (3150)
{
...
BOOL func_13() // Position - 0xC8F (3215)
{
	Vehicle vehiclePedIsIn;
...
int func_14(var uParam0, const char* sParam1, int iParam2) // Position - 0xCC9 (3273)
{
...
void func_15(const char* sParam0, int iParam1) // Position - 0xD15 (3349)
{
...
BOOL func_16(var uParam0) // Position - 0xD31 (3377)
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(const char* message) // Position - 0xD8B (3467)
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

BOOL func_18(const char* sParam0, int iParam1) // Position - 0xD9E (3486)
{
...
BOOL func_19(var uParam0) // Position - 0xDB7 (3511)
{
	var unk;
...
struct<8> func_20(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, float fParam8) // Position - 0xE5B (3675)
{
	var unk;
	var unk9;
...
Vector3 func_21(float fParam0, var uParam1, var uParam2) // Position - 0xEBD (3773)
{
	float num;
	float num2;
...
BOOL func_22(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0xEFC (3836)
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5), vParam1) <= fParam4 * fParam4;
}

int func_23(var uParam0, const char* sParam1) // Position - 0xF1A (3866)
{
	if (MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		return 0;
...
void func_24(const char* sParam0) // Position - 0xF63 (3939)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, true, true, -1);
	return;
...
void func_25(var uParam0) // Position - 0xF79 (3961)
{
	if (func_16(uParam0))
		HUD::CLEAR_HELP(true);
...
BOOL func_26() // Position - 0xFA6 (4006)
{
	Vehicle vehiclePedIsIn;
...
BOOL func_27(Vehicle veParam0, int iParam1) // Position - 0xFFA (4090)
{
	int num;
...
BOOL func_28(Vehicle veParam0) // Position - 0x1096 (4246)
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Vehicle veParam0) // Position - 0x10C0 (4288)
{
...
BOOL func_30(Vehicle veParam0) // Position - 0x10E1 (4321)
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0))
		if (ENTITY::IS_ENTITY_DEAD(veParam0, false))
			return true;
...
int func_31() // Position - 0x1124 (4388)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_32(int iParam0) // Position - 0x1172 (4466)
{
	return Global_61500[iParam0];
}

eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x1181 (4481)
{
	func_34();
	return Global_114162.f_2367.f_539.f_4321;
}

void func_34() // Position - 0x119A (4506)
{
...
BOOL func_35(eCharacter echParam0) // Position - 0x1297 (4759)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x12A3 (4771)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x12E0 (4832)
{
...
Hash func_38(eCharacter echParam0) // Position - 0x1305 (4869)
{
	return Global_2201[echParam0 /*29*/];
}

int func_39(Player plParam0) // Position - 0x1314 (4884)
{
	int num;
...
int func_40(Player plParam0) // Position - 0x1326 (4902)
{
	if (plParam0 > -1)
...
BOOL func_41(Player plParam0) // Position - 0x1369 (4969)
{
	if (!func_42(plParam0))
		return false;
...
BOOL func_42(Player plParam0) // Position - 0x1388 (5000)
{
	Player player;
...
void func_43(var uParam0, int iParam1) // Position - 0x13AA (5034)
{
...
BOOL func_44(var uParam0) // Position - 0x13BE (5054)
{
	func_76(PLAYER::PLAYER_PED_ID());
...
BOOL func_45() // Position - 0x1477 (5239)
{
	return MISC::GET_GAME_TIMER() <= Global_23987.f_6481 + 100;
}

BOOL func_46(BOOL bParam0) // Position - 0x148C (5260)
{
	if (bParam0)
...
BOOL func_47(int iParam0) // Position - 0x14B5 (5301)
{
	if (iParam0 == 0)
		if (func_54())
			return false;
...
BOOL func_48(Player plParam0) // Position - 0x1525 (5413)
{
	if (func_51(plParam0))
		return true;
...
BOOL func_49(Player plParam0) // Position - 0x1548 (5448)
{
	Player player;
...
BOOL func_50(Player plParam0, int iParam1) // Position - 0x1566 (5478)
{
	return IS_BIT_SET(Global_1887694[plParam0 /*611*/].f_10.f_4, iParam1);
}

BOOL func_51(Player plParam0) // Position - 0x157E (5502)
{
	Player player;
...
BOOL func_53(int iParam0) // Position - 0x15C3 (5571)
{
	if (iParam0 == 1)
...
BOOL func_54() // Position - 0x161A (5658)
{
	if (Global_44199 == 15)
		return false;
...
void func_55(var uParam0) // Position - 0x162F (5679)
{
	if (uParam0->f_11 == 1)
...
void func_56(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x1664 (5732)
{
	int i;
	float num;
	float num2;
...
void func_57(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x1719 (5913)
{
	func_58(uParam0->[0 /*3*/], uParam0->[1 /*3*/], uParam0->f_7, iParam1, iParam2, iParam3, iParam4);
	return;
}

void func_58(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x173F (5951)
{
	var unk;
	var unk4;
	float num;
...
Vector3 func_59(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x194F (6479)
{
...
void func_60(int iParam0) // Position - 0x1988 (6536)
{
	int shapeTestResult;
	Entity entityHit;
	var endCoords;
...
void func_61(BOOL bParam0) // Position - 0x1A79 (6777)
{
	bParam0;
	return;
}

int func_62(Vehicle veParam0) // Position - 0x1A86 (6790)
{
...
int func_63(Vehicle veParam0) // Position - 0x1AF1 (6897)
{
	var minimum;
	float maximum;
...
BOOL func_64(Vehicle veParam0) // Position - 0x1C82 (7298)
{
	Hash entityModel;
...
BOOL func_65(Hash hParam0) // Position - 0x1EE1 (7905)
{
...
BOOL func_66(Vehicle veParam0, BOOL bParam1) // Position - 0x2122 (8482)
{
	if (Global_79564)
...
float func_67(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x2170 (8560)
{
...
void func_68() // Position - 0x21AA (8618)
{
...
void func_69(var uParam0, int iParam1) // Position - 0x2239 (8761)
{
...
void func_72(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x22F9 (8953)
{
...
float func_73(float fParam0, float fParam1, float fParam2) // Position - 0x2322 (8994)
{
	if (fParam0 > fParam2)
		return fParam2;
...
void func_74(var uParam0, int iParam1, char* sParam2, var uParam3, var uParam4, var uParam5, int iParam6, char* sParam7, int iParam8, float fParam9) // Position - 0x2349 (9033)
{
	uParam0->f_5 = sParam2;
	uParam0->f_1 = { uParam3 };
	uParam0->f_4 = sParam7;
...
Vector3 func_75(int iParam0) // Position - 0x23BE (9150)
{
	int num;
...
BOOL func_76(Vehicle veParam0) // Position - 0x23D6 (9174)
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0))
		return false;
...
void func_77() // Position - 0x23F4 (9204)
{
	func_78(&iLocal_38);
	func_25(&uLocal_87);
	SCRIPT::TERMINATE_THIS_THREAD();
...
void func_78(var uParam0) // Position - 0x240C (9228)
{
	int i;
...
void func_79(var uParam0) // Position - 0x2435 (9269)
{
	*uParam0 = 0;
	return;
}
