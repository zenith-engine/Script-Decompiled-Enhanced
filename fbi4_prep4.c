...
void _TRIGGER_MISSION_FAIL(int iParam0) // Position - 0x28C (652)
{
	int num;
...
BOOL func_155(Vehicle veParam0) // Position - 0x8440 (33856)
{
	if (PLAYER::PLAYER_ID() != _INVALID_PLAYER_INDEX())
	{
		...
		if (func_159(PLAYER::PLAYER_ID(), true, false) && Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_36 > PV_COMP_HEAD || IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_34, 14) || IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_34, 11))
			return false;
...
ePedComponentType func_157() // Position - 0x8552 (34130)
{
...
BOOL func_162() // Position - 0x861A (34330)
{
...
BOOL func_174(ePedComponentType epctParam0) // Position - 0x9268 (37480)
{
...
BOOL func_175(ePedComponentType epctParam0, BOOL bParam1, int iParam2) // Position - 0x9426 (37926)
{
	int i;
	Hash outData;
...
BOOL func_178(ePedComponentType epctParam0, int iParam1) // Position - 0x968E (38542)
{
	int cloudTimeAsInt;
	int num;
	int i;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x98BB (39099)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x98D1 (39121)
{
...
BOOL func_227(Player plParam0) // Position - 0xD031 (53297)
{
	Player player;
...
BOOL func_228(Player plParam0) // Position - 0xD055 (53333)
{
	Player player;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xF212 (61970)
{
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xF2CF (62159)
{
