...
BOOL func_92(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE688 (59016)
{
	int num;
	int num2;
	int num3;
...
BOOL func_150(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x1FA23 (129571)
{
	ePedComponentType entityModel;
	ePedComponentType type;
	int i;
...
struct<2> func_158(eCharacter echParam0) // Position - 0x1FE8D (130701)
{
	var unk;
	var unk3;
