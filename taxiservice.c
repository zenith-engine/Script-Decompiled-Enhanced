...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x2EAE (11950)
{
	...
	switch (iLocal_951)
	{
		...
		case 6:
			...
			if (echLocal_823 != -1)
			{
				...
				if (Global_92476[echLocal_823 /*34*/].f_13 == -1 && Global_92476[echLocal_823 /*34*/].f_14 == -1)
					flag2 = false;
			
				if (flag2)
					if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_MICHAEL && !IS_BIT_SET(Global_92476[echLocal_823 /*34*/].f_15, 8) || _GET_CURRENT_PLAYER_CHARACTER() == CHAR_FRANKLIN && !IS_BIT_SET(Global_92476[echLocal_823 /*34*/].f_15, 9) || _GET_CURRENT_PLAYER_CHARACTER() == CHAR_TREVOR && !IS_BIT_SET(Global_92476[echLocal_823 /*34*/].f_15, 10))
						flag2 = false;
			
				if (flag2)
					if (func_110(Global_92476[echLocal_823 /*34*/].f_13, Global_92476[echLocal_823 /*34*/].f_14))
						flag2 = false;
			
				if (flag2)
					CLOCK::ADVANCE_CLOCK_TIME_TO(Global_92476[echLocal_823 /*34*/].f_13, 0, 0);
			}
		...
		case 7:
			...
			if (echLocal_823 != -1 && Global_98615)
				flag = false;
		...
		case 9:
			...
			{
				if (!Global_98616 && echLocal_823 != -1 && echLocal_823 != CHAR_MP_MEX_BOSS && echLocal_823 != CHAR_MP_STRIPCLUB_PR)
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xF93E (63806)
{
