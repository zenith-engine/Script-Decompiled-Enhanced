...
int func_62(eCharacter echParam0) // Position - 0x3382 (13186)
{
	...
	{
		if (func_68(echParam0, Global_21083) == 1)
		{
			func_67(echParam0, Global_21083, 0);
		
			if (func_66(echParam0, Global_21083) == 0)
			{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x38B7 (14519)
{
...
void func_90(int iParam0, int iParam1) // Position - 0x468F (18063)
{
	...
	{
		case 1:
			Global_33485[num /*23*/].f_12[0] = BLIP_SAFEHOUSE;
			break;
	
		case 3:
			Global_33485[num /*23*/].f_12[0] = BLIP_POLICE_STATION;
			break;
	}
...
void func_99(int iParam0, eBlipSprite ebsParam1) // Position - 0x4D4C (19788)
{
	...
	if (Global_33485[num /*23*/].f_12[0] == ebsParam1)
		return;

	Global_33485[num /*23*/].f_12[0] = ebsParam1;
