...
void func_84(Vehicle veParam0, eCharacter echParam1) // Position - 0x3E04 (15876)
{
	Ped pedInVehicleSeat;
	int i;
	int j;
...
BOOL func_90(ePedComponentType epctParam0, int iParam1) // Position - 0x450A (17674)
{
	int cloudTimeAsInt;
	int num;
	int i;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x4737 (18231)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x474D (18253)
{
...
void func_118(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, eCharacter echParam6) // Position - 0x67F0 (26608)
{
	if (func_115(&Global_78354.f_555[0 /*21*/], iParam0))
	{
...
eCharacter func_124(Vehicle veParam0) // Position - 0x6AE4 (27364)
{
	int i;
...
int func_133(Vector3 vParam0, var uParam1, var uParam2, eCharacter echParam3, int iParam4) // Position - 0x72E9 (29417)
{
	int i;
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x768C (30348)
{
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x78D4 (30932)
{
...
void func_150(int iParam0, BOOL bParam1) // Position - 0x7999 (31129)
{
