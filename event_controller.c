...
Hash func_34(Player plParam0, int iParam1) // Position - 0x15AF (5551)
{
	if (func_24(iParam1))
	{
		if (Global_2628534)
...
int func_36(Hash hParam0) // Position - 0x17C8 (6088)
{
	switch (hParam0)
	{
		case 15:
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x22FD (8957)
{
...
BOOL func_111(int iParam0) // Position - 0x36AD (13997)
{
	return Global_1574538[iParam0];
}

BOOL func_112() // Position - 0x36BD (14013)
{
