...
void main() // Position - 0x0 (0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(eScriptParam_0))
	{
		...
		epctLocal_314 = Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_36;
...
void func_2() // Position - 0xCE5 (3301)
{
	...
	if (type > PV_COMP_INVALID && type != _INVALID_PLAYER_INDEX())
	{
		for (i = 0; i < 33; i = i + 1)
		{
			if (Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_36 == Global_1845270[type /*892*/].f_268[i])
			{
				if (func_9(i) != -1)
				{
...
int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x8EA9 (36521)
{
	int i;
