...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x76E3 (30435)
{
...
ePedComponentType func_83() // Position - 0x770D (30477)
{
...
BOOL func_86(ePedComponentType epctParam0) // Position - 0x7751 (30545)
{
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x8608 (34312)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x901B (36891)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x9031 (36913)
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x9089 (37001)
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB5A3 (46499)
{
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBEA8 (48808)
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
void func_207(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDBD4 (56276)
{
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE5A0 (58784)
{
	var unk;
	...
	if (func_261(*panParam0) || func_259(*panParam0) || Global_79810 == true)
		return true;
...
int func_269(Ped pedParam0, eCharacter echParam1) // Position - 0x100E3 (65763)
{
	int num;
...
char* func_294(char* sParam0) // Position - 0x14C23 (85027)
{
	return sParam0;
}
