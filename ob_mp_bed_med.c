...
void func_2() // Position - 0x30E (782)
{
	...
	switch (iLocal_326)
	{
		...
		case 7:
			...
			if (INTERIOR::IS_INTERIOR_READY(INTERIOR::GET_INTERIOR_AT_COORDS(uLocal_337)) && !func_9() && !func_7() && Global_1574633.f_8 == false)
			{
				bLocal_328 = true;
				MISC::CLEAR_BIT(&iLocal_324, 0);
				iLocal_330 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(uLocal_347, uLocal_350, 2, false, false, 1065353216, 0, 1065353216);
...
int func_61(Player plParam0, ePedComponentType epctParam1) // Position - 0x1DD9 (7641)
{
	if (func_64(plParam0) == epctParam1)
...
ePedComponentType func_64(Player plParam0) // Position - 0x1E5D (7773)
{
	if (func_23(plParam0))
		if (func_63(plParam0, false))
