...
void _STOPWATCH_INITIALIZE(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x793 (1939)
{
	if (pStopwatch->f_1 == 0)
	{
...
BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x948 (2376)
{
	if (millis == -1)
		return 1;
...
ePedComponentType func_32(int iParam0, int iParam1) // Position - 0x2DB8 (11704)
{
	Hash statHash;
	int outValue;
...
BOOL func_43(int iParam0) // Position - 0x3561 (13665)
{
	return Global_1574538[iParam0];
}

BOOL func_44() // Position - 0x3571 (13681)
{
...
ePedComponentType func_46(Player plParam0) // Position - 0x3601 (13825)
{
...
void func_61(int iParam0, ePedComponentType epctParam1, int iParam2, BOOL bParam3) // Position - 0x7B7D (31613)
{
	Hash statName;
...
ePedComponentType func_63(Hash hParam0, Hash hParam1, int iParam2) // Position - 0x7D2E (32046)
{
	int num;
...
void func_67(int iParam0, ePedComponentType epctParam1, int iParam2) // Position - 0x7E0A (32266)
{
	BOOL flag;
	int num;
	...
	if (!func_133(num, epctParam1 == func_32(iParam0, -1)))
	{
		flag = false;
	}
	else
...
BOOL _NETWORK_IS_PLAYER_VALID(ePedComponentType player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x9BC7 (39879)
{
	ePedComponentType type;
...
BOOL func_94(int iParam0, int iParam1) // Position - 0x9D47 (40263)
{
	...
	type = func_95(iParam0, iParam1);
	type2 = func_113(iParam0, iParam1);
	return type2 >= type;
}

ePedComponentType func_95(int iParam0, int iParam1) // Position - 0x9D68 (40296)
{
	int i;
...
ePedComponentType func_113(int iParam0, int iParam1) // Position - 0xCFCA (53194)
{
	int i;
	ePedComponentType type;
	BOOL flag;
	...
	switch (iParam0)
	{
		case 9:
			switch (iParam1)
			{
				...
				case 79:
					...
					{
						type = type + func_128(_STAT_GET_PACKED_BOOL(9547, -1));
						type = type + func_128(_STAT_GET_PACKED_BOOL(9548, -1));
		...
		case 2:
			switch (iParam1)
			{
				...
				case 19:
					...
					else if (func_113(2, 20) > PV_COMP_HEAD)
					{
		...
		case 30:
			switch (iParam1)
			{
				...
				case 327:
					type = func_123(40, -1) + func_123(41, -1);
					break;
		...
		case 3:
			switch (iParam1)
			{
				...
				case 27:
					...
					else if (func_113(3, 28) > PV_COMP_HEAD)
					{
		...
		case 4:
			switch (iParam1)
			{
				...
				case 35:
					...
					else if (func_113(4, 36) > PV_COMP_HEAD)
					{
		...
		case 5:
			switch (iParam1)
			{
				...
				case 43:
					...
					else if (func_113(5, 44) > PV_COMP_HEAD)
					{
		...
		case 6:
			switch (iParam1)
			{
				...
				case 51:
					...
					else if (func_113(6, 52) > PV_COMP_HEAD)
					{
		...
		case 7:
			switch (iParam1)
			{
				...
				case 59:
					...
					else if (func_113(7, 60) > PV_COMP_HEAD)
					{
		...
		case 8:
			switch (iParam1)
			{
				...
				case 67:
					...
					else if (func_113(8, 68) > PV_COMP_HEAD)
					{
		...
		case 20:
			switch (iParam1)
			{
				...
				case 216:
					...
					else if (func_123(111, -1) > PV_COMP_HEAD)
					{
						type = PV_COMP_BERD;
				...
				case 223:
					type = func_114(114, -1) ? PV_COMP_BERD : 0;
					break;
		...
		case 23:
			switch (iParam1)
			{
				case 254:
					...
					if (func_125(flag) > PV_COMP_BERD || IS_BIT_SET(flag, 1))
						type = PV_COMP_BERD;
					break;
		...
		case 14:
			switch (iParam1)
			{
				...
				case 148:
					type = SYSTEM::FLOOR(SYSTEM::TO_FLOAT(func_32(12025, -1) / 60));
					break;
		...
		case 29:
			switch (iParam1)
			{
				...
				case 321:
					type = type + func_125(func_32(11929, -1));
					type = type + func_125(func_32(11966, -1));
					type = type + func_125(func_32(11967, -1));
					type = type + func_125(func_32(11968, -1));
					break;
...
ePedComponentType func_116() // Position - 0x126AB (75435)
{
	int num;
	BOOL flag;
...
ePedComponentType func_118() // Position - 0x1271A (75546)
{
	BOOL flag;
	BOOL flag2;
...
ePedComponentType func_119() // Position - 0x12793 (75667)
{
	BOOL address;
	int i;
	Hash weaponHash;
...
ePedComponentType func_123(int iParam0, int iParam1) // Position - 0x12F54 (77652)
{
	Hash statHash;
	int outValue;
...
ePedComponentType func_125(ePedComponentType epctParam0) // Position - 0x12F8E (77710)
{
	int num;
	BOOL flag;
...
ePedComponentType func_127() // Position - 0x12FE3 (77795)
{
	int num;
	int num2;
...
ePedComponentType func_136(Hash hParam0, Hash hParam1, int iParam2) // Position - 0x1483B (84027)
{
	int num;
...
int func_146(Any* panParam0) // Position - 0x14D09 (85257)
{
	int num;
	int i;
...
BOOL func_150(Hash hParam0, Hash hParam1) // Position - 0x159A2 (88482)
{
	...
	p_num = func_151(hParam0, hParam1);
	action = func_54(hParam0, hParam1);
...
int* func_151(Hash hParam0, Hash hParam1) // Position - 0x159C7 (88519)
{
	...
	p_num = Global_2751072.f_991[func_144(hParam0, hParam1)];
	return p_num;
}
...
BOOL func_169() // Position - 0x180A4 (98468)
{
...
BOOL func_171() // Position - 0x180D5 (98517)
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x180EE (98542)
{
	int profileSetting;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x1820F (98831)
{
...
BOOL func_218(ePedComponentType epctParam0) // Position - 0x1C9C4 (117188)
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (epctParam0 == Global_262145.f_33775[i])
			return true;
	}
