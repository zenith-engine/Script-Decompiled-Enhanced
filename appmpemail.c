...
void main() // Position - 0x0 (0)
{
	...
	while (true)
	{
		...
		if (Global_23476 == false && Global_23475 == true)
			func_73();
	
		if (Global_23476 == true && Global_23475 == false)
			func_68();
		...
		if (Global_21083.f_1 != 9 && Global_23476 == false && Global_23475 == false)
		{
...
void func_12() // Position - 0x522 (1314)
{
	...
	if (Global_21061 == false && iLocal_40 == 1)
	{
...
void func_16(char* sParam0) // Position - 0x101D (4125)
{
...
int func_46(eCharacter echParam0, eCharacter echParam1) // Position - 0x1E11 (7697)
{
...
void func_60() // Position - 0x2267 (8807)
{
	...
	if (Global_21061 == false)
	{
		if (func_3(FRONTEND_CONTROL, Global_21052, 0) || Global_4546008 == 1 || Global_23502 == true)
		{
			if (Global_4546008 == 0 && Global_23502 == false)
				func_50();
			...
			if (Global_4542454[iLocal_34 /*296*/].f_24 != 0)
			{
				...
				if (Global_4546008 == 1 || Global_23502 == true)
				{
...
BOOL func_66(char* sParam0) // Position - 0x330B (13067)
{
...
BOOL func_77(char* sParam0) // Position - 0x3D8A (15754)
{
	switch (MISC::GET_HASH_KEY(sParam0))
	{
		case -793228278:
