...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x8B8 (2232)
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x13F9 (5113)
{
...
eCharacter func_123(int iParam0, BOOL bParam1) // Position - 0x6CF0 (27888)
{
	eCharacter character;
	int num;
...
void func_261(Vehicle veParam0, eCharacter echParam1) // Position - 0xE6FA (59130)
{
	Ped pedInVehicleSeat;
	int i;
	int j;
...
BOOL func_272(ePedComponentType epctParam0, int iParam1) // Position - 0xF41C (62492)
{
	int cloudTimeAsInt;
	int num;
	int i;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0xF649 (63049)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0xF65F (63071)
{
...
eCharacter func_283(Vehicle veParam0) // Position - 0xF88F (63631)
{
	int i;
