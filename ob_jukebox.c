#region Local Var
	...
	ePedComponentType epctLocal_138 = PV_COMP_HEAD;
	int iLocal_139 = 0;
	ePedComponentType epctLocal_140 = PV_COMP_HEAD;
	ePedComponentType epctLocal_141 = PV_COMP_HEAD;
...
void main() // Position - 0x0 (0)
{
	...
	epctLocal_142 = Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_36;
	...
	if (IS_GAMER_HANDLE_VALID(gamerHandle))
		if (NETWORK::NETWORK_IS_GAMER_IN_MY_SESSION(&gamerHandle))
			epctLocal_138 = NETWORK::NETWORK_GET_PLAYER_FROM_GAMER_HANDLE(&gamerHandle);

	if (epctLocal_142 == 126)
	{
		epctLocal_138 = func_230(PLAYER::PLAYER_ID());
	...
	else if (epctLocal_142 == 130)
	{
		epctLocal_138 = func_230(PLAYER::PLAYER_ID());
	}

	if (epctLocal_138 == _INVALID_PLAYER_INDEX())
		func_254(false);
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		if (epctLocal_142 == 126)
		{
			if (Global_1845270[epctLocal_138 /*892*/].f_268.f_391 > epctLocal_151)
				Global_1845270[epctLocal_138 /*892*/].f_268.f_391 = epctLocal_151;
		
			if (Global_1845270[epctLocal_138 /*892*/].f_268.f_391 != epctLocal_151 && func_226(epctLocal_138))
			{
				func_222(Global_1845270[epctLocal_138 /*892*/].f_268.f_391);
				func_217(true);
				iLocal_171.f_1 = 0.5f;
				iLocal_171 = 1;
		...
		{
			if (Global_1845270[epctLocal_138 /*892*/].f_268.f_392 > epctLocal_151)
				Global_1845270[epctLocal_138 /*892*/].f_268.f_392 = epctLocal_151;
		
			if (Global_1845270[epctLocal_138 /*892*/].f_268.f_392 != epctLocal_151)
			{
				func_222(Global_1845270[epctLocal_138 /*892*/].f_268.f_392);
				func_217(true);
				iLocal_171.f_1 = 0.5f;
				iLocal_171 = 1;
				iLocal_171.f_3 = iLocal_139;
		...
		{
			if (Global_1845270[epctLocal_138 /*892*/].f_268.f_388 > epctLocal_151)
				Global_1845270[epctLocal_138 /*892*/].f_268.f_388 = epctLocal_151;
		
			if (Global_1845270[epctLocal_138 /*892*/].f_268.f_388 != epctLocal_151)
			{
				func_222(Global_1845270[epctLocal_138 /*892*/].f_268.f_388);
				func_217(true);
				iLocal_171 = 1;
				iLocal_171.f_3 = iLocal_139;
				func_216();
	...
	while (true)
	{
		...
		else if (epctLocal_142 != PV_COMP_INVALID && epctLocal_142 <= 131)
		{
			uLocal_161 = { func_1() };
...
{
	if (func_6(epctLocal_142, -1))
		return func_4(epctLocal_142);
	else if (epctLocal_142 == 126)
		return func_3();
	else if (epctLocal_142 == 130)
		return func_2();
...
{
	if (epctLocal_138 == PLAYER::PLAYER_ID() && func_215())
	{
...
void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x855 (2133)
{
...
BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0xDAB (3499)
{
	if (millis == -1)
		return true;
...
void _STOPWATCH_INITIALIZE(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0xE09 (3593)
{
	if (pStopwatch->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
...
void func_25() // Position - 0xE5A (3674)
{
	...
	if (iLocal_171.f_3 != iLocal_139)
	{
		...
		if (epctLocal_138 == PLAYER::PLAYER_ID() && iLocal_171.f_4)
		{
			if (epctLocal_142 == 126)
			{
				func_26(26808, iLocal_139, -1);
				Global_1845270[epctLocal_138 /*892*/].f_268.f_391 = iLocal_139;
			}
			else if (epctLocal_142 == 130)
			{
				func_26(41216, iLocal_139, -1);
				Global_1845270[epctLocal_138 /*892*/].f_268.f_392 = iLocal_139;
			}
			else
			{
				func_26(9355, iLocal_139, -1);
				Global_1845270[epctLocal_138 /*892*/].f_268.f_388 = iLocal_139;
			}
		}
	}
	...
	if (IS_BIT_SET(iLocal_147, 6) != flag)
	{
		...
		if (epctLocal_138 == PLAYER::PLAYER_ID() && iLocal_171.f_4 && !flag)
		{
			if (epctLocal_142 == 126)
			{
				func_26(26808, epctLocal_151, -1);
				Global_1845270[epctLocal_138 /*892*/].f_268.f_391 = epctLocal_151;
			}
			else if (epctLocal_142 == 130)
			{
				func_26(41216, epctLocal_151, -1);
				Global_1845270[epctLocal_138 /*892*/].f_268.f_392 = epctLocal_151;
			}
			else
			{
				func_26(9355, epctLocal_151, -1);
				Global_1845270[epctLocal_138 /*892*/].f_268.f_388 = epctLocal_151;
			}
		}
	}
	...
	switch (iLocal_154)
	{
		...
		case 4:
			...
			if (!ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_152, "EXIT", 3))
			{
				...
				if (epctLocal_140 != PV_COMP_INVALID)
			...
			else if (PED::GET_SYNCHRONIZED_SCENE_PHASE(localSceneFromNetworkId) >= 0.96f)
			{
				...
				if (epctLocal_142 == 126)
					epctLocal_150 = Global_1845270[epctLocal_138 /*892*/].f_268.f_391;
				else if (epctLocal_142 == 130)
					epctLocal_150 = Global_1845270[epctLocal_138 /*892*/].f_268.f_392;
				else
					epctLocal_150 = Global_1845270[epctLocal_138 /*892*/].f_268.f_388;
			
				if (epctLocal_150 == epctLocal_151)
					epctLocal_150 = PV_COMP_INVALID;
			
				STATS::PLAYSTATS_MC_CLUBHOUSE_ACTIVITY(func_50(_GET_BOSS_OF_LOCAL_PLAYER()), func_49(_GET_BOSS_OF_LOCAL_PLAYER()), func_48(), func_47(), 4, epctLocal_150, 0, func_28());
				func_197(0);
			}
			break;
	}
...
char* func_29() // Position - 0x12DB (4827)
{
	...
	else if (Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_36 != PV_COMP_INVALID)
	{
...
ePedComponentType func_44(ePedComponentType epctParam0) // Position - 0x2999 (10649)
{
...
ePedComponentType func_46() // Position - 0x2A16 (10774)
{
...
int func_49(ePedComponentType epctParam0) // Position - 0x2A66 (10854)
{
	if (epctParam0 == _INVALID_PLAYER_INDEX())
		return -1;
...
int func_50(ePedComponentType epctParam0) // Position - 0x2A8B (10891)
{
	if (epctParam0 == _INVALID_PLAYER_INDEX())
		return -1;
...
ePedComponentType _GET_BOSS_OF_LOCAL_PLAYER() // Position - 0x2AB0 (10928)
{
	return Global_1887694[PLAYER::PLAYER_ID() /*611*/].f_10;
}

void func_52(ePedComponentType epctParam0) // Position - 0x2AC5 (10949)
{
	uLocal_176[PLAYER::PLAYER_ID() /*3*/].f_1 = epctParam0;
...
void func_67(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x2FBB (12219)
{
	...
	if (bParam3)
	{
		...
		{
			func_103(Global_23987.f_5821 + 1, "DFLT_MNU_OPT" /*Exit*/, 0, true, false, false, false);
		...
		if (i == 1 || !Global_23987.f_6331)
		{
			...
			for (j = PV_COMP_HEAD; j <= type; j = j + 1)
			{
				...
				if (flag && i == 1 && flag2)
				{
					...
					func_97("CommonMenu", "Gradient_Nav", Global_23984 + (iParam5 * 0.5f), num40 + num44 + (0.00277776f * (float)num5) + (num37 * 0.5f), iParam5, num37, 0f, r2, g2, b2, a2, false, 0);
								...
								if (flag2)
								{
									if (!Global_23987.f_6332)
									{
										...
										if (MISC::GET_HASH_KEY(&Global_23987.f_79[num16 /*6*/]) != 0)
										{
											...
											func_80(flag, Global_23987.f_1616[num16], Global_23987.f_1873[num16], flag7, num45, flag5, flag4);
...
void func_74(float fParam0, float fParam1, char* sParam2, ePedComponentType epctParam3, int iParam4) // Position - 0x624F (25167)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
eCharacter func_87(int iParam0, BOOL bParam1) // Position - 0x6CCD (27853)
{
...
BOOL func_88(ePedComponentType epctParam0) // Position - 0x6D0E (27918)
{
	Player player;
...
void func_103(ePedComponentType epctParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x7666 (30310)
{
	int num;
	float num2;
	float num3;
...
void func_106(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x78DB (30939)
{
	int num;
...
BOOL func_111(BOOL bParam0, BOOL bParam1) // Position - 0x7BCA (31690)
{
	...
	if (!CAM::IS_SCREEN_FADED_IN() || func_113(8, -1) && func_112() != TRANSITION_STATE_WAITING_FOR_EXTERNAL_TERMINATION_CALL || HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1 || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0 || NETWORK::IS_COMMERCE_STORE_OPEN() || Global_79825 || Global_23987.f_9115 || HUD::IS_WARNING_MESSAGE_ACTIVE() || Global_101765.f_1490)
		return false;

	return true;
}

eTransitionState func_112() // Position - 0x7C67 (31847)
{
...
void func_115() // Position - 0x7CE1 (31969)
{
	...
	else if (epctLocal_140 == epctLocal_151)
		if (epctLocal_141 == PV_COMP_HEAD)
			func_116("JBOX_CONF_OFF" /*Would you like to turn off the jukebox?*/, 0, 0);
		else
			func_116("JBOX_CANC_PUR" /*Go back to playlist selection.*/, 0, 0);
	else if (epctLocal_141 == PV_COMP_HEAD)
...
void func_117() // Position - 0x7DBA (32186)
{
	...
	if (epctLocal_141 == epctLocal_151)
	{
		func_116("JBOX_TOFF" /*Turn the jukebox off.*/, 0, 0);
	}
	else if (epctLocal_141 == iLocal_171.f_3 && func_215())
	{
	...
	else
	{
		...
		if (epctLocal_142 != 126 && epctLocal_142 != 130 && epctLocal_141 >= PV_COMP_LOWR)
			TEXT_LABEL_APPEND_INT(&unk, epctLocal_141 + 5, 16);
		else
			TEXT_LABEL_APPEND_INT(&unk, epctLocal_141, 16);
	
		if (epctLocal_141 == epctLocal_151 - 1)
			if (epctLocal_138 != PLAYER::PLAYER_ID())
...
void func_121(ePedComponentType epctParam0, BOOL bParam1, int iParam2) // Position - 0x7F24 (32548)
{
	ePedComponentType i;
	int num;
...
void func_131() // Position - 0x8816 (34838)
{
	...
	for (i = PV_COMP_HEAD; i < type; i = i + 1)
	{
		...
		if (epctLocal_142 != 126 && epctLocal_142 != 130 && i >= PV_COMP_LOWR)
...
BOOL func_133(ePedComponentType epctParam0) // Position - 0x89B8 (35256)
{
	if (epctLocal_138 != PLAYER::PLAYER_ID() || !func_118() && epctParam0 == epctLocal_151 - 1)
		return true;
...
{
	if (epctLocal_142 == 126 || epctLocal_142 == 130)
		return 20;
...
void func_138() // Position - 0x8BF6 (35830)
{
	...
	if (flag2)
	{
		epctLocal_141 = epctLocal_141 + 1;
	
		if (epctLocal_141 > func_157())
			epctLocal_141 = PV_COMP_HEAD;
	...
	if (isControlJustPressed)
	{
		...
		switch (iLocal_153)
		{
			case 1:
				iLocal_153 = 0;
				epctLocal_141 = PV_COMP_HEAD;
				epctLocal_140 = epctLocal_151;
				func_197(4);
				MISC::CLEAR_BIT(&iLocal_147, 5);
				break;
		
			case 0:
				if (epctLocal_141 != iLocal_171.f_3 || !func_215() && !func_133(epctLocal_141))
				{
					epctLocal_140 = epctLocal_141;
					iLocal_153 = 2;
					epctLocal_141 = PV_COMP_HEAD;
					MISC::SET_BIT(&iLocal_147, 1);
			...
			case 2:
				if (epctLocal_141 == PV_COMP_HEAD)
				{
					...
					if (epctLocal_140 != epctLocal_151)
					{
						MISC::SET_BIT(&iLocal_147, 5);
						func_139(epctLocal_140);
					}
				}
				else
				{
...
void func_139(ePedComponentType epctParam0) // Position - 0x8ECE (36558)
{
...
void _NETSHOPPING_PROCESS_TRANSACTION(Hash hParam0, ePedComponentType epctParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x8F51 (36689)
{
	int num;
...
int func_141(var uParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, ePedComponentType epctParam5, int iParam6, int iParam7) // Position - 0x98D0 (39120)
{
	BOOL flag;
	BOOL flag2;
	int i;
...
void func_142(int iParam0, Hash hParam1, int iParam2, ePedComponentType epctParam3, int iParam4) // Position - 0x9A7D (39549)
{
	switch (hParam1)
	{
		case joaat("SERVICE_SPEND_BETTING"):
...
void func_144(ePedComponentType epctParam0) // Position - 0x9B09 (39689)
{
	epctParam0->f_65 = 0;
...
void func_147(BOOL bParam0, Hash hParam1) // Position - 0x9C87 (40071)
{
...
int func_151(ePedComponentType epctParam0) // Position - 0x9E7C (40572)
{
	var address;
...
char* func_153(ePedComponentType epctParam0) // Position - 0x9EAE (40622)
{
	switch (epctParam0)
	{
		case 0:
...
char* func_154(ePedComponentType epctParam0) // Position - 0x9FC5 (40901)
{
	switch (epctParam0)
	{
		case 0:
...
char* func_155(ePedComponentType epctParam0) // Position - 0xA0DC (41180)
{
	switch (epctParam0)
	{
		case 0:
...
ePedComponentType func_157() // Position - 0xA1D3 (41427)
{
	int num;
...
void func_158(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xA21C (41500)
{
	if (MISC::IS_PC_VERSION() && !NETWORK::NETWORK_TEXT_CHAT_IS_TYPING())
	{
		...
		if (func_162())
		{
			if (Global_4542450 == epctLocal_141)
			{
				*uParam2 = 1;
			}
			else
			{
				epctLocal_141 = Global_4542450;
				func_121(epctLocal_141, true, 1);
			}
		}
...
void _CONTEXT_REMOVE_HELP_TEXT(var uParam0) // Position - 0xB443 (46147)
{
	int num;
...
void func_213() // Position - 0xB99F (47519)
{
	if (func_208())
	{
		...
		{
			if (uLocal_176[iLocal_171.f_2 /*3*/].f_1 == epctLocal_151)
			{
				if (func_215())
				{
					iLocal_171 = 0;
					iLocal_171.f_3 = epctLocal_151;
				
					if (epctLocal_138 == iLocal_171.f_2)
						iLocal_171.f_4 = 1;
				}
			}
	...
	if (!func_208())
		if (epctLocal_142 == 126)
			if (Global_1845270[epctLocal_138 /*892*/].f_268.f_391 == iLocal_171.f_3 && !func_215() && Global_1845270[epctLocal_138 /*892*/].f_268.f_391 == epctLocal_151)
				iLocal_171.f_4 = 0;
		else if (epctLocal_142 == 130)
			if (Global_1845270[epctLocal_138 /*892*/].f_268.f_392 == iLocal_171.f_3 && !func_215() && Global_1845270[epctLocal_138 /*892*/].f_268.f_392 == epctLocal_151)
				iLocal_171.f_4 = 0;
		else if (Global_1845270[epctLocal_138 /*892*/].f_268.f_388 == iLocal_171.f_3 && !func_215() && Global_1845270[epctLocal_138 /*892*/].f_268.f_388 == epctLocal_151)
			iLocal_171.f_4 = 0;
...
void func_217(BOOL bParam0) // Position - 0xBC24 (48164)
{
	...
	if (func_6(epctLocal_142, -1))
		func_221(epctLocal_142, bParam0);
	else if (epctLocal_142 == 126)
		func_220(bParam0);
	else if (epctLocal_142 == 130)
		func_218(bParam0);
...
void func_221(ePedComponentType epctParam0, BOOL bParam1) // Position - 0xBD0C (48396)
{
	if (func_5(epctParam0) == 97)
	{
...
void func_222(int iParam0) // Position - 0xBD65 (48485)
{
	if (func_6(epctLocal_142, -1))
	{
		if (iParam0 != epctLocal_151 && iParam0 != -1)
		{
			if (epctLocal_138 == PLAYER::PLAYER_ID() && iLocal_148 != 0)
				func_9(iLocal_139);
		
			func_225(epctLocal_142, iParam0);
		}
	
		if (iParam0 != -1)
			iLocal_139 = iParam0;
	}
	else if (epctLocal_142 == 126 || epctLocal_142 == 130)
	{
		if (iParam0 != epctLocal_151 && iParam0 != -1)
		{
			if (epctLocal_138 == PLAYER::PLAYER_ID() && iLocal_148 != 0)
...
void func_225(ePedComponentType epctParam0, int iParam1) // Position - 0xBE93 (48787)
{
	char* radioStation;
...
BOOL func_226(ePedComponentType epctParam0) // Position - 0xBF0E (48910)
{
	return func_228(epctParam0) && func_227(epctParam0);
}

BOOL func_227(ePedComponentType epctParam0) // Position - 0xBF27 (48935)
{
...
BOOL func_228(ePedComponentType epctParam0) // Position - 0xBF5B (48987)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		return IS_BIT_SET(Global_1845270[epctParam0 /*892*/].f_268.f_435.f_1, 2);
...
ePedComponentType func_230(ePedComponentType epctParam0) // Position - 0xBF8C (49036)
{
	int num;
	...
	{
		num = func_234(func_44(epctParam0));
	
		if (num == 2 || num == 1 || num == 0 || num == 25)
		{
			if (func_232(epctParam0, false))
				return func_231(epctParam0);
...
ePedComponentType func_231(ePedComponentType epctParam0) // Position - 0xC01B (49179)
{
	if (func_88(epctParam0))
...
BOOL func_232(ePedComponentType epctParam0, BOOL bParam1) // Position - 0xC03E (49214)
{
	if (!func_88(epctParam0))
		return false;
	...
	return func_88(Global_1887694[epctParam0 /*611*/].f_10);
}

BOOL func_233(ePedComponentType epctParam0) // Position - 0xC076 (49270)
{
	if (func_88(epctParam0))
		if (func_88(Global_1887694[epctParam0 /*611*/].f_10))
			return Global_1887694[epctParam0 /*611*/].f_10 == epctParam0;

	return false;
}

int func_234(ePedComponentType epctParam0) // Position - 0xC0AB (49323)
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0xC706 (50950)
{
	int i;
...
Player func_244() // Position - 0xC839 (51257)
{
	Player player;

	player = Global_2657994[PLAYER::PLAYER_ID() /*467*/].f_324.f_9;
	return player;
}

BOOL func_245(ePedComponentType epctParam0) // Position - 0xC855 (51285)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
...
void func_246() // Position - 0xC8BB (51387)
{
	...
	else if (epctLocal_142 != Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_36)
	{
		func_254(false);
	}
...
BOOL func_248(ePedComponentType epctParam0) // Position - 0xCB10 (51984)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
		if (func_250(epctParam0) && !func_249(epctParam0))
			return true;

	return false;
}

BOOL func_249(ePedComponentType epctParam0) // Position - 0xCB49 (52041)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
...
BOOL func_250(ePedComponentType epctParam0) // Position - 0xCB7A (52090)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
...
BOOL func_252(ePedComponentType epctParam0) // Position - 0xCBB7 (52151)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
			if (Global_2657994[epctParam0 /*467*/].f_324.f_8 != PV_COMP_INVALID)
				return func_234(Global_2657994[epctParam0 /*467*/].f_324.f_8) == 26;
