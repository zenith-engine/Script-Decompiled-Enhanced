...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x76DF (30431)
{
...
ePedComponentType func_83() // Position - 0x7709 (30473)
{
...
BOOL func_86(ePedComponentType epctParam0) // Position - 0x774D (30541)
{
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x8603 (34307)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x9016 (36886)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x902C (36908)
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x9084 (36996)
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB5D1 (46545)
{
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBED6 (48854)
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
void func_201(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD689 (54921)
{
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE0E9 (57577)
{
	var unk;
	...
	if (func_256(*panParam0) || func_254(*panParam0) || Global_79810 == true)
		return true;
...
int func_264(Ped pedParam0, eCharacter echParam1) // Position - 0xFC4C (64588)
{
	int num;
