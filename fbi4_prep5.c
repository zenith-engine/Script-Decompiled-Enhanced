...
void _TRIGGER_MISSION_FAIL(int iParam0) // Position - 0x286 (646)
{
	int num;
...
BOOL func_157(Vehicle veParam0) // Position - 0x865F (34399)
{
	if (PLAYER::PLAYER_ID() != _INVALID_PLAYER_INDEX())
	{
		...
		if (func_161(PLAYER::PLAYER_ID(), true, false) && Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_36 > PV_COMP_HEAD || IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_34, 14) || IS_BIT_SET(Global_1845270[PLAYER::PLAYER_ID() /*892*/].f_268.f_34, 11))
			return false;
...
ePedComponentType func_159() // Position - 0x8771 (34673)
{
...
BOOL func_164() // Position - 0x8839 (34873)
{
...
BOOL func_176(ePedComponentType epctParam0) // Position - 0x9487 (38023)
{
...
BOOL func_177(ePedComponentType epctParam0, BOOL bParam1, int iParam2) // Position - 0x9645 (38469)
{
	int i;
	Hash outData;
...
BOOL func_180(ePedComponentType epctParam0, int iParam1) // Position - 0x98AD (39085)
{
	int cloudTimeAsInt;
	int num;
	int i;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x9ADA (39642)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x9AF0 (39664)
{
...
BOOL func_229(Player plParam0) // Position - 0xD251 (53841)
{
	Player player;
...
BOOL func_230(Player plParam0) // Position - 0xD275 (53877)
{
	Player player;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xF4D3 (62675)
{
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xFA36 (64054)
{
