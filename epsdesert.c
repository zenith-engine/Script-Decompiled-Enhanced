...
int func_11(Ped pedParam0, int iParam1, ePedComponentType epctParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xA2F (2607)
{
	...
	if (iParam5 == 0)
	{
		Global_79347[1 /*14*/] = { func_64(entityModel, iParam1, epctParam2, -1) };
...
{
	Global_79347[1 /*14*/] = { func_64(hParam0, iParam1, epctParam2, -1) };
...
struct<14> func_64(Hash hParam0, int iParam1, ePedComponentType epctParam2, int iParam3) // Position - 0xB68F (46735)
{
	func_127();
...
void func_65(int iParam0, ePedComponentType epctParam1) // Position - 0xB6E1 (46817)
{
	switch (iParam0)
	{
		case 0:
...
void func_85(ePedComponentType epctParam0) // Position - 0x102C4 (66244)
{
	if (epctParam0 < 136)
		func_87(epctParam0);
	else
...
void func_90(int iParam0, ePedComponentType epctParam1) // Position - 0x12021 (73761)
{
	switch (iParam0)
	{
		case 0:
...
void func_103(ePedComponentType epctParam0) // Position - 0x16F30 (94000)
{
	if (epctParam0 < 107)
		func_106(epctParam0);
...
void func_109(int iParam0, ePedComponentType epctParam1) // Position - 0x197FB (104443)
{
	switch (iParam0)
	{
		case 0:
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x1F092 (127122)
{
...
BOOL func_140(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x1F493 (128147)
{
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79347[1 /*14*/] = { func_64(entityModel, epctParam1, epctParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_140(pedParam0, i, unk[i]))
				{
								...
								for (k = 0; k <= 19; k = k + 1)
								{
									...
									if (Global_79347[2 /*14*/].f_12 == j)
										if (func_140(pedParam0, 14, k))
											if (!func_17(entityModel, epctParam2, 14, k, &unk, &Global_79347[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79347[2 /*14*/] = { func_64(entityModel, i, type, -1) };
					
						if (!func_17(entityModel, epctParam2, i, type, &unk, &Global_79347[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79347[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_21(epctParam1)) && Global_79347[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_21(epctParam1)))
	{
		return true;
	}
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x1FFD2 (131026)
{
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x200A9 (131241)
{
