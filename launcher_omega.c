...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x75C4 (30148)
{
...
ePedComponentType func_83() // Position - 0x75EE (30190)
{
...
BOOL func_86(ePedComponentType epctParam0) // Position - 0x7632 (30258)
{
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x84E9 (34025)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8EFC (36604)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8F12 (36626)
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8F6A (36714)
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB4B7 (46263)
{
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBDBC (48572)
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
void func_204(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD340 (54080)
{
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD7A2 (55202)
{
	var unk;
	...
	if (func_252(*panParam0) || func_250(*panParam0) || Global_79810 == true)
		return true;
...
int func_261(Ped pedParam0, eCharacter echParam1) // Position - 0xF5AD (62893)
{
	int num;
