...
void _CONTEXT_REMOVE_HELP_TEXT(var uParam0) // Position - 0x18A (394)
{
	int num;
...
void func_72() // Position - 0x1890 (6288)
{
	func_75(2, &uLocal_120, 0);
	func_75(3, &uLocal_120, 1);
	func_73(&uLocal_120, 6347);
	return;
}

void func_73(var uParam0, int iParam1) // Position - 0x18B2 (6322)
{
...
BOOL func_74(var uParam0, var uParam1) // Position - 0x18CB (6347)
{
	return !Global_33376;
}

void func_75(int iParam0, var uParam1, int iParam2) // Position - 0x18D7 (6359)
{
	var unk;
	float num;
...
Vector3 func_76() // Position - 0x195F (6495)
{
	return -0.67f, -1.66f, 0.7f;
}

Vector3 func_77() // Position - 0x1976 (6518)
{
	return -0.67f, 0f, -1.3f;
}

Vector3 func_78(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x1989 (6537)
{
	float num;
	float num2;
	float num3;
...
Vector3 func_79() // Position - 0x19CD (6605)
{
	return func_78({ -60f, 4841.945f, 362.58f } - func_80(), 180f - -66.83f);
}

Vector3 func_80() // Position - 0x19F8 (6648)
{
	return 361.89f, 4842.36f, -59.25f;
}

void func_81(int iParam0, var uParam1, var uParam2) // Position - 0x1A0F (6671)
{
	switch (iParam0)
	{
		case 0:
...
void func_82() // Position - 0x1AC6 (6854)
{
...
void func_83(int iParam0, var uParam1, int iParam2) // Position - 0x1ADE (6878)
{
	var unk;
	float num;
...
Vector3 func_84() // Position - 0x1B65 (7013)
{
	return 0f, -1.74f, 2f;
}

Vector3 func_85() // Position - 0x1B74 (7028)
{
	return 0f, 0f, 0f;
}

Vector3 func_86() // Position - 0x1B7F (7039)
{
	return func_78({ -60f, 4845.8f, 364.74f } - func_87(), -4f);
}

Vector3 func_87() // Position - 0x1BA4 (7076)
{
	return 364.74f, 4846.2f, -60f;
}

void func_88(int iParam0, var uParam1, var uParam2) // Position - 0x1BBB (7099)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_89(Player plParam0) // Position - 0x1C56 (7254)
{
	return IS_BIT_SET(Global_1845270[plParam0 /*892*/].f_268.f_306.f_1, 0);
}

void func_90() // Position - 0x1C71 (7281)
{
	return;
}

int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x1C79 (7289)
{
	int i;
...
BOOL func_92(BOOL bParam0) // Position - 0x1D8F (7567)
{
	bParam0;
