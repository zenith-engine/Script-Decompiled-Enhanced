...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7751 (30545)
{
...
ePedComponentType func_83() // Position - 0x777B (30587)
{
...
BOOL func_86(ePedComponentType epctParam0) // Position - 0x77BF (30655)
{
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x867A (34426)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x908D (37005)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x90A3 (37027)
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x90FB (37115)
{
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBF0A (48906)
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xD736 (55094)
{
...
void func_205(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD81B (55323)
{
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xDCAA (56490)
{
	var unk;
	...
	if (func_254(*panParam0) || func_252(*panParam0) || Global_79810 == true)
		return true;
...
int func_266(Ped pedParam0, eCharacter echParam1) // Position - 0xFB81 (64385)
{
	int num;
