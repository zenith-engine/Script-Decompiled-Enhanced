...
void _TRIGGER_MISSION_FAIL(int iParam0) // Position - 0x361 (865)
{
	int num;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0x1A4C (6732)
{
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x3095 (12437)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x30AB (12459)
{
...
BOOL func_86(Player plParam0) // Position - 0x5F1F (24351)
{
	Player player;
...
BOOL func_143(var uParam0, eCharacter echParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8) // Position - 0x82FC (33532)
{
...
void func_156(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x8993 (35219)
{
...
int func_186(Vector3 vParam0, var uParam1, var uParam2, eCharacter echParam3, int iParam4) // Position - 0x9C1A (39962)
{
	int i;
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xA945 (43333)
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xFD09 (64777)
{
