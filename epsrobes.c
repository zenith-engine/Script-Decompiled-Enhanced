			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_49(pedParam0, i, unk[i]))
				{
					...
					else
					{
						...
						if (!func_53(entityModel, iParam2, i, type, &unk, &Global_79347[2 /*14*/]))
							return false;
					}
				}
			}
...
int func_140(Hash hParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3, int iParam4) // Position - 0x1DB9F (121759)
{
	int num;
	int i;
	int j;
	...
	Global_79347[1 /*14*/] = { func_70(hParam0, iParam1, epctParam2, -1) };
...
int func_141(Hash hParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0x1DF81 (122753)
{
	Global_79347[1 /*14*/] = { func_70(hParam0, iParam1, epctParam2, -1) };
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x1E3C3 (123843)
{
...
void func_164(eCharacter echParam0, int iParam1, int iParam2, char* sParam3, const char* sParam4, const char* sParam5, const char* sParam6, const char* sParam7, const char* sParam8, const char* sParam9, const char* sParam10, const char* sParam11, const char* sParam12, const char* sParam13) // Position - 0x1ECDA (126170)
{
	eCharacter character;
	BOOL flag;
	var txdName;
...
void func_185(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x204AB (132267)
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x2055F (132447)
{
