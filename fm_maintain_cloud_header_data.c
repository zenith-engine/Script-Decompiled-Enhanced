...
BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x16D1 (5841)
{
	if (millis == -1)
		return true;
...
void _STOPWATCH_INITIALIZE(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x172F (5935)
{
	if (pStopwatch->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
...
BOOL IS_XBOX_PLATFORM() // Position - 0x1C8A (7306)
{
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x2821 (10273)
{
...
void func_78(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x284B (10315)
{
	if (func_112(hParam0))
...
void func_113(ePedComponentType epctParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x323A (12858)
{
...
void func_153(int iParam0, ePedComponentType epctParam1, int iParam2, BOOL bParam3) // Position - 0x4179 (16761)
{
	Hash statName;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			type = func_18(func_160(iParam1, iParam0->f_2), Global_79344);
		
			if (IS_BIT_SET(type, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			type = func_18(func_159(iParam1, iParam0->f_2), Global_79344);
		
			if (IS_BIT_SET(type, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 2);
		
			if (func_154(iParam1, iParam0->f_2, &num))
			{
				type = func_18(num, Global_79344);
...
ePedComponentType func_210(int iParam0, int iParam1) // Position - 0x1FDB7 (130487)
{
	int num;
	ePedComponentType type;
...
void func_212(int iParam0, int iParam1, int iParam2) // Position - 0x1FE3C (130620)
{
	...
	type = type + iParam1;
	func_153(iParam0, type, iParam2, true);
	return;
}
...
ePedComponentType func_216(int iParam0) // Position - 0x20338 (131896)
{
	ePedComponentType type;

	type = func_18(func_215(iParam0), -1);
	return type;
}
...
BOOL func_217(int iParam0) // Position - 0x2034F (131919)
{
	...
	type = func_216(iParam0);
	num = iParam0;
	return IS_BIT_SET(type, func_209(num));
}
...
BOOL func_225(int iParam0) // Position - 0x2137F (136063)
{
	...
	p_num = func_226(iParam0);
	num = iParam0;
	return IS_BIT_SET(p_num, func_209(num));
}
...
int* func_226(int iParam0) // Position - 0x2139C (136092)
{
	...
	p_num = Global_2751072.f_1032[func_207(iParam0)];
	return p_num;
}
...
ePedComponentType func_228(int iParam0, int iParam1) // Position - 0x21413 (136211)
{
	ePedComponentType type;

	type = func_18(func_229(iParam0), iParam1);
	return type;
}
...
void func_230(int iParam0, int iParam1) // Position - 0x217A6 (137126)
{
	...
	type = type + 1;
	func_153(iParam0, type, iParam1, true);
	return;
}
...
BOOL func_234(var uParam0, const char* sParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x21836 (137270)
{
	var unk;
	Any* fileDict;
	Any* dict;
...
void func_239(ePedComponentType epctParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0x22769 (141161)
{
	Hash hash;
	...
	if (func_28())
	{
		if (epctParam0 == PV_COMP_HEAD)
			if (iParam1 != 6 && iParam1 != 5 && iParam1 != 4 && iParam1 != 9)
				if (func_244(PLAYER::PLAYER_ID()) < epctParam2)
					return;
	
		hash = func_243(epctParam0, iParam1, bParam3);
...
Hash func_243(ePedComponentType epctParam0, int iParam1, BOOL bParam2) // Position - 0x22826 (141350)
{
	switch (epctParam0)
	{
		case PV_COMP_HAIR:
...
ePedComponentType func_244(Player plParam0) // Position - 0x22987 (141703)
{
	ePedComponentType type;

	type = func_247(plParam0);

	if (type < PV_COMP_HEAD)
		return PV_COMP_HEAD;

	return func_245(type, 0);
}

ePedComponentType func_245(ePedComponentType epctParam0, int iParam1) // Position - 0x229A8 (141736)
{
	int i;
	int value;
	int value2;
...
ePedComponentType func_246(int iParam0) // Position - 0x22A63 (141923)
{
	int num;
	int num2;
...
ePedComponentType func_247(Player plParam0) // Position - 0x22F9E (143262)
{
...
void func_250(ePedComponentType epctParam0, int iParam1, BOOL bParam2, ePedComponentType epctParam3, BOOL bParam4) // Position - 0x23036 (143414)
{
	Hash hash;
	...
	if (epctParam0 == PV_COMP_HEAD)
		if (iParam1 != 6 && iParam1 != 5 && iParam1 != 4 && iParam1 != 9)
			if (func_244(PLAYER::PLAYER_ID()) < epctParam3)
				return;
	else if (epctParam0 == PV_COMP_HAIR)
		if (epctParam3 >= 9999)
			return;

	hash = func_251(epctParam0, iParam1, bParam4);
...
Hash func_251(ePedComponentType epctParam0, int iParam1, BOOL bParam2) // Position - 0x230BB (143547)
{
	switch (epctParam0)
	{
		case PV_COMP_HAIR:
...
void func_255(ePedComponentType epctParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x23F43 (147267)
{
	var unk;
	Hash hash;

	if (!func_257(epctParam0, iParam1, iParam2, &unk, epctParam3))
		return;
...
BOOL func_257(ePedComponentType epctParam0, int iParam1, int iParam2, var uParam3, ePedComponentType epctParam4) // Position - 0x23FEA (147434)
{
	int num;
	...
	if (func_244(PLAYER::PLAYER_ID()) < epctParam4)
		return false;
...
void func_263(ePedComponentType epctParam0, int iParam1, int iParam2, ePedComponentType epctParam3, BOOL bParam4) // Position - 0x245C6 (148934)
{
	var unk;
	Hash hash;
...
void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x26B7E (158590)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
		if (!useAccurateTime)
			*pStopwatch = NETWORK::GET_NETWORK_TIME();
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x26EFC (159484)
{
