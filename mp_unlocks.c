...
void func_53(var uParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0x27BB (10171)
{
	var unk;
	int num;
	...
	if (*uParam0 > num)
	{
		...
		func_55(1, *uParam0, iLocal_164, *uParam0, &unk, "PM_UGEN_NUM" /*~1~/~1~*/, epctParam1, epctParam2);
		*uParam0 = *uParam0 + 1;
		return;
	}
	...
	if (num == *uParam0)
	{
		...
		if (!bParam3)
			...
			func_54(1, *uParam0, iLocal_164, *uParam0, &unk, "NUMBR" /*~1~*/, epctParam1);
...
void func_54(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, ePedComponentType epctParam6) // Position - 0x2895 (10389)
{
	if (GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD_ON_FRONTEND("SET_DATA_SLOT"))
	{
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
...
void func_55(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, ePedComponentType epctParam6, ePedComponentType epctParam7) // Position - 0x28E9 (10473)
{
	if (GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD_ON_FRONTEND("SET_DATA_SLOT"))
	{
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
...
ePedComponentType func_60(int iParam0) // Position - 0x2B31 (11057)
{
	ePedComponentType type;
...
ePedComponentType func_61() // Position - 0x2D37 (11575)
{
	int num;
...
ePedComponentType func_63() // Position - 0x2DDB (11739)
{
	int num;
...
ePedComponentType func_64() // Position - 0x2DF8 (11768)
{
	int num;
...
ePedComponentType func_65() // Position - 0x2E13 (11795)
{
	int num;
...
ePedComponentType func_66() // Position - 0x2E2E (11822)
{
	int num;
...
ePedComponentType func_67() // Position - 0x2E49 (11849)
{
	int num;
...
ePedComponentType func_68() // Position - 0x2E66 (11878)
{
	int num;
...
int func_69(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x2EA1 (11937)
{
	bParam1;
	return func_70(epctParam0, 0);
}

int func_70(ePedComponentType epctParam0, int iParam1) // Position - 0x2EB5 (11957)
{
	int i;
	int value;
	int value2;
...
ePedComponentType func_71(int iParam0) // Position - 0x2F70 (12144)
{
	int num;
	int num2;
...
ePedComponentType func_72(Player plParam0, BOOL bParam1) // Position - 0x34AB (13483)
{
	bParam1;
	return func_73(plParam0);
}

ePedComponentType func_73(Player plParam0) // Position - 0x34BE (13502)
{
...
BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x3A28 (14888)
{
	if (millis == -1)
		return true;
...
void _STOPWATCH_INITIALIZE(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x3A86 (14982)
{
	if (pStopwatch->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x3ACB (15051)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x3AE1 (15073)
{
