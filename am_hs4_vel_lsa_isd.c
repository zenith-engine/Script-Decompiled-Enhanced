...
void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x539 (1337)
{
...
BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x594 (1428)
{
	if (millis == -1)
		return true;
...
void _STOPWATCH_INITIALIZE(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x5F2 (1522)
{
	if (pStopwatch->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
...
int _GET_LOBBY_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer, BOOL includeSpectators) // Position - 0x24A8 (9384)
{
	int address;
	int i;
	Player player;
...
BOOL func_144(Player plParam0) // Position - 0xB4BA (46266)
{
	Player player;
...
BOOL func_145(Player plParam0) // Position - 0xB4DE (46302)
{
	Player player;
...
BOOL func_146(Player plParam0, int iParam1) // Position - 0xB4FC (46332)
{
...
BOOL func_191(Ped pedParam0, int iParam1) // Position - 0x12FD8 (77784)
{
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_M_Freemode_01"))
		{
			...
			{
				flag = func_196(pedParam0, 11, PV_COMP_INVALID);
			
				if (flag >= 237)
				{
					componentHash = func_192(joaat("MP_M_Freemode_01"), flag, 11, 3);
		...
		else if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_F_Freemode_01"))
		{
			...
			{
				flag2 = func_196(pedParam0, 11, PV_COMP_INVALID);
			
				if (flag2 >= 256)
				{
					componentHash2 = func_192(joaat("MP_F_Freemode_01"), flag2, 11, 4);
...
Hash func_192(Hash hParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x13298 (78488)
{
	var outProp;
	int componentId;
	int num;
	...
	else if (iParam2 == 14)
	{
		...
		componentId = bParam1 - func_195(hParam0);
	...
	else
	{
		...
		componentId2 = bParam1 - func_193(hParam0, func_194(iParam2));
...
BOOL func_196(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x1386A (79978)
{
	BOOL i;
	BOOL j;
...
BOOL func_197(Ped pedParam0, int iParam1) // Position - 0x1390B (80139)
{
...
BOOL func_199(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x139C2 (80322)
{
	int pedPropIndex;
...
BOOL func_205(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x13DE3 (81379)
{
	Hash entityModel;
	BOOL flag;
	Hash hash;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79347[1 /*14*/] = { func_221(entityModel, iParam1, bParam2, -1) };
	hash = Global_2883588;
	...
	if (iParam1 == 12)
	{
		unk = { func_217(entityModel, bParam2) };
		...
		for (k = 0; k < 7; k = k + 1)
		{
			...
			if (unk[num] != -99)
			{
				if (!func_205(pedParam0, num, unk[num]))
				{
					Global_2883588 = hash;
					...
					if (num == 13)
					{
						unk18 = { func_214(entityModel, unk[num]) };
							...
							if (!func_205(pedParam0, 14, unk18[i]))
							{
								for (j = 0; j <= 19; j = j + 1)
								{
									...
									if (Global_79347[2 /*14*/].f_12 == i)
									{
										...
										{
											if (!func_209(entityModel, bParam2, 14, j, &unk, &Global_79347[2 /*14*/]))
											{
												Global_2883588 = hash;
												Global_2883589 = hash2;
												return false;
					...
					else
					{
						...
						Global_79347[2 /*14*/] = { func_221(entityModel, num, flag, -1) };
					
						if (!func_209(entityModel, bParam2, num, flag, &unk, &Global_79347[2 /*14*/]))
						{
							Global_2883588 = hash;
							Global_2883589 = hash2;
							return false;
	...
	{
		unk28 = { func_214(entityModel, bParam2) };
		...
		if (iParam1 == 4)
		{
			...
			if (Global_79346 == 1)
				if (func_208(entityModel, 11, func_197(pedParam0, 11), -1))
					if (func_207(entityModel, 4, bParam2, &flag2))
						return func_205(pedParam0, 4, flag2);
				else if (func_206(entityModel, 4, bParam2, &flag2))
					return func_205(pedParam0, 4, flag2);
...
BOOL func_206(Hash hParam0, int iParam1, BOOL bParam2, var uParam3) // Position - 0x1423F (82495)
{
	Hash componentHash;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 4:
					if (bParam2 >= 256)
					{
						componentHash = func_192(hParam0, bParam2, iParam1, 4);
...
BOOL func_207(Hash hParam0, int iParam1, BOOL bParam2, var uParam3) // Position - 0x142E8 (82664)
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_208(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x14390 (82832)
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 11:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_192(hParam0, bParam2, 11, 4);
...
BOOL func_209(Hash hParam0, int iParam1, int iParam2, BOOL bParam3, var uParam4, int iParam5) // Position - 0x143E3 (82915)
{
	var unk;
	int i;
	...
	{
		if (func_212(hParam0, iParam2, bParam3, -1))
		{
		...
		else if (func_211(hParam0, iParam2, bParam3, -1))
		{
		...
		else if (func_210(hParam0, iParam2, bParam3, -1))
		{
			if (iParam1 == 1 || iParam1 == 2 || iParam1 == 4 || iParam1 == 5 || iParam1 == 10 || iParam1 == 11 || iParam1 == 12 || iParam1 == 14 || iParam1 == 18 || iParam1 == 50)
				return false;
...
BOOL func_210(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x149E7 (84455)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
		...
		case joaat("MP_M_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_192(hParam0, bParam2, 14, 3);
					
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_192(hParam0, bParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_192(hParam0, bParam2, 1, 3);
					
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_192(hParam0, bParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_192(hParam0, bParam2, 14, 4);
					
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_192(hParam0, bParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_192(hParam0, bParam2, 1, 4);
					
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_192(hParam0, bParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
BOOL func_211(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x14C64 (85092)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_212(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x15089 (86153)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_213(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x1537C (86908)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<17> func_217(Hash hParam0, int iParam1) // Position - 0x15EB6 (89782)
{
	...
	switch (hParam0)
	{
		...
		case joaat("Player_Two"):
			...
			{
				case 0:
					func_220(&unk, -99, -99, false, 91, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				...
				case 12:
					func_220(&unk, -99, -99, false, 93, 29, 0, 13, 0, 0, -99, 0, 0, 31);
					break;
				...
				case 21:
					func_220(&unk, -99, -99, false, 44, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 22:
					func_220(&unk, -99, -99, 98, false, 28, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 23:
					func_220(&unk, -99, -99, 27, false, 31, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				...
				case 42:
					func_220(&unk, -99, -99, 55, false, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 43:
					func_220(&unk, -99, -99, false, 52, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				...
				case 46:
					func_220(&unk, -99, -99, false, false, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
		...
		case joaat("MP_M_Freemode_01"):
			...
			{
				case 0:
					func_220(&unk, -99, -99, false, false, 10, -99, 0, -99, -99, 0, 0, 0, 31);
					break;
			
				case 1:
					func_220(&unk, -99, -99, true, 127, 38, -99, 2, 0, 0, 0, 0, 62, 0);
					break;
			
				case 2:
					func_220(&unk, -99, -99, false, 248, 45, -99, 240, 0, 0, 0, 0, 144, 1);
					break;
				...
				case 4:
					func_220(&unk, -99, -99, true, 66, 10, -99, 21, 0, 0, 0, 0, 123, 3);
					break;
			
				case 5:
					func_220(&unk, -99, -99, true, 93, 141, -99, 3, 0, 0, 0, 0, 114, 4);
					break;
			
				case 6:
					func_220(&unk, -99, -99, true, 116, 113, -99, 7, 0, 0, 0, 0, 113, 5);
					break;
			
				case 7:
					func_220(&unk, -99, -99, true, 61, 136, -99, 27, 0, 0, 0, 0, 61, 6);
					break;
			
				case 8:
					func_220(&unk, -99, -99, false, 112, 10, -99, 240, 0, 0, 0, 0, 8, 7);
					break;
				...
				case 10:
					func_220(&unk, -99, -99, true, 209, 188, -99, 208, 0, 0, 0, 0, 64, 9);
					break;
			
				case 11:
					func_220(&unk, -99, -99, true, 209, 160, -99, 211, 0, 0, 0, 43, 157, 10);
					break;
			
				case 12:
					func_220(&unk, -99, -99, true, 162, 174, -99, 201, 0, 0, 0, 0, 158, 11);
					break;
			
				case 13:
					func_220(&unk, -99, -99, true, 4, 240, -99, 34, 0, 0, 0, 0, 97, 12);
					break;
			
				case 14:
					func_220(&unk, -99, -99, true, 128, 232, -99, 43, 0, 0, 0, 0, 102, 13);
					break;
			
				case 15:
					func_220(&unk, -99, -99, true, 66, 65, -99, 224, 0, 0, 0, 0, 100, 14);
					break;
			
				case 16:
					func_220(&unk, -99, -99, true, 65, 172, -99, 202, 0, 0, 0, 0, 64, 15);
					break;
			
				case 17:
					func_220(&unk, -99, -99, true, 64, 10, -99, 1, 0, 0, 0, 0, 66, 16);
					break;
				...
				case 20:
					func_220(&unk, -99, -99, true, 124, 96, -99, 11, 0, 0, 0, 0, 110, 19);
					break;
			
				case 21:
					func_220(&unk, -99, -99, false, 80, 114, -99, 240, 0, 0, 0, 0, 2, 20);
					break;
				...
				case 23:
					func_220(&unk, -99, -99, true, 116, 144, -99, 2, 0, 0, 0, 0, 108, 22);
					break;
			
				case 24:
					func_220(&unk, -99, -99, true, 63, 38, -99, 3, 0, 0, 0, 0, 63, 23);
					break;
		...
		case joaat("MP_F_Freemode_01"):
			...
			{
				case 0:
					func_220(&unk, -99, -99, false, false, 0, -99, 0, -99, -99, 0, -99, 0, 31);
					break;
				...
				case 2:
					func_220(&unk, -99, -99, 4, true, 96, -99, 32, 0, 0, 0, 7, 215, 0);
					break;
			
				case 3:
					func_220(&unk, -99, -99, true, 73, 241, -99, 3, 0, 0, 0, 0, 25, 1);
					break;
				...
				case 6:
					func_220(&unk, -99, -99, true, 140, 241, -99, 7, 0, 0, 0, 31, 16, 4);
					break;
				...
				case 8:
					func_220(&unk, -99, -99, true, 193, 48, -99, 108, 0, 0, 0, 0, 17, 6);
					break;
				...
				case 13:
					func_220(&unk, -99, -99, 5, false, 0, -99, 10, 0, 0, 0, 0, 130, 31);
					break;
				...
				case 23:
					func_220(&unk, -99, -99, false, 73, 178, -99, 32, 0, 0, 0, 38, 11, 19);
					break;
...
void func_220(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17F98 (98200)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = bParam3;
...
struct<14> func_221(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x1800C (98316)
{
	func_267();

	if (hParam0 == joaat("MP_M_Freemode_01"))
		func_251(iParam1, bParam2, hParam3);
	else if (hParam0 == joaat("MP_F_Freemode_01"))
		func_222(iParam1, bParam2, hParam3);
		...
		if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_M_Freemode_01"))
		{
			...
			switch (pedDrawableVariation)
			{
				...
				default:
					if (pedDrawableVariation > 15)
					{
						flag2 = func_196(pedParam0, 8, PV_COMP_INVALID);
					
						if (flag2 >= 241)
						{
							componentHash2 = func_192(joaat("MP_M_Freemode_01"), flag2, 8, 3);
			...
			switch (pedDrawableVariation)
			{
				case 0:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num2 = func_277(joaat("MP_F_Freemode_01"), 11, func_196(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				default:
					if (pedDrawableVariation > 15)
					{
						flag3 = func_196(pedParam0, 11, PV_COMP_INVALID);
					
						if (flag3 >= 256)
						{
							componentHash3 = func_192(joaat("MP_F_Freemode_01"), flag3, 11, 4);
			...
			switch (pedDrawableVariation)
			{
				case 0:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num3 = func_277(joaat("MP_F_Freemode_01"), 11, func_196(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				default:
					if (pedDrawableVariation > 15)
					{
						flag4 = func_196(pedParam0, 8, PV_COMP_INVALID);
					
						if (flag4 >= 136)
						{
							componentHash4 = func_192(joaat("MP_F_Freemode_01"), flag4, 8, 4);
...
int func_277(Hash hParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x3432D (213805)
{
	Hash componentHash;
	...
	if (hParam0 == joaat("MP_M_Freemode_01"))
	{
		if (iParam1 == 11)
		{
			...
			{
				componentHash = func_192(hParam0, bParam2, 11, 3);
		...
		else if (iParam1 == 8)
		{
			...
			{
				componentHash2 = func_192(hParam0, bParam2, 8, 3);
	...
	else if (hParam0 == joaat("MP_F_Freemode_01"))
	{
		if (iParam1 == 11)
		{
			...
			{
				componentHash3 = func_192(hParam0, bParam2, 11, 4);
		...
		else if (iParam1 == 8)
		{
			...
			{
				componentHash4 = func_192(hParam0, bParam2, 8, 4);
