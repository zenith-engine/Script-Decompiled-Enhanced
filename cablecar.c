...
int func_123(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x4CC0 (19648)
{
	...
	if (iParam5 == 0)
	{
		Global_79347[1 /*14*/] = { func_171(entityModel, iParam1, bParam2, -1) };
...
{
	Global_79347[1 /*14*/] = { func_171(hParam0, iParam1, bParam2, -1) };
...
void func_143(Ped pedParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x7B46 (31558)
{
	...
	else
	{
		...
		if (epctParam1 == PV_COMP_HEAD)
		{
			...
			if (func_144(ENTITY::GET_ENTITY_MODEL(pedParam0), 14, flag, FILES::GET_HASH_NAME_FOR_PROP(pedParam0, 0, iParam2, iParam3)))
			{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (bParam2 >= 327)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_145(hParam0, bParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (bParam2 >= 26)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_145(hParam0, bParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (bParam2 >= 327)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_145(hParam0, bParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (bParam2 >= 26)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_145(hParam0, bParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
struct<14> func_171(Hash hParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xF899 (63641)
{
	func_234();
...
BOOL func_235(Ped pedParam0, ePedComponentType epctParam1, BOOL bParam2) // Position - 0x233E7 (144359)
{
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79347[1 /*14*/] = { func_171(entityModel, epctParam1, bParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_235(pedParam0, i, unk[i]))
				{
								...
								for (k = 0; k <= 19; k = k + 1)
								{
									...
									if (Global_79347[2 /*14*/].f_12 == j)
										if (func_235(pedParam0, 14, k))
											if (!func_129(entityModel, bParam2, 14, k, &unk, &Global_79347[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79347[2 /*14*/] = { func_171(entityModel, i, flag, -1) };
					
						if (!func_129(entityModel, bParam2, i, flag, &unk, &Global_79347[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79347[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_133(epctParam1)) && Global_79347[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_133(epctParam1)))
	{
		return true;
	}
