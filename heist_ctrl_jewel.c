...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x10A8 (4264)
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x5E49 (24137)
{
...
void _CONTEXT_REMOVE_HELP_TEXT(var uParam0) // Position - 0x64B9 (25785)
{
	int num;
...
int func_163(var uParam0, int iParam1, eCharacter echParam2) // Position - 0x7C82 (31874)
{
	...
	{
		if (!func_179(Global_100152[echParam2 /*3*/], 0f, 0f, 0f, false))
		{
			unk.f_11 = 12;
			unk.f_31 = 49;
			unk.f_81 = 2;
...
void func_192(var uParam0, int iParam1) // Position - 0xCDAD (52653)
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_180(Global_114162.f_18537[i], &unk, &num))
			{
