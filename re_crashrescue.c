...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x1229 (4649)
{
...
int func_81(Ped pedParam0, int iParam1, ePedComponentType epctParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x2EC3 (11971)
{
	...
	if (iParam5 == 0)
	{
		Global_79347[1 /*14*/] = { func_133(entityModel, iParam1, epctParam2, -1) };
...
{
	Global_79347[1 /*14*/] = { func_133(epctParam0, iParam1, epctParam2, -1) };
...
struct<14> func_133(ePedComponentType epctParam0, int iParam1, ePedComponentType epctParam2, int iParam3) // Position - 0xDC1C (56348)
{
	func_196();
...
BOOL func_140(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xFF72 (65394)
{
	int num;
	int num2;
	int num3;
...
BOOL func_197(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x21663 (136803)
{
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79347[1 /*14*/] = { func_133(entityModel, epctParam1, epctParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_197(pedParam0, i, unk[i]))
				{
								...
								for (k = 0; k <= 19; k = k + 1)
								{
									...
									if (Global_79347[2 /*14*/].f_12 == j)
										if (func_197(pedParam0, 14, k))
											if (!func_87(entityModel, epctParam2, 14, k, &unk, &Global_79347[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79347[2 /*14*/] = { func_133(entityModel, i, type, -1) };
					
						if (!func_87(entityModel, epctParam2, i, type, &unk, &Global_79347[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79347[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_91(epctParam1)) && Global_79347[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_91(epctParam1)))
	{
		return true;
	}
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x21D33 (138547)
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x28FAD (167853)
{
