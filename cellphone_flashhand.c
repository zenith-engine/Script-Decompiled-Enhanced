...
BOOL func_60(Hash hParam0) // Position - 0x4E59 (20057)
{
	int i;
...
BOOL func_62(int* piParam0, int iParam1) // Position - 0x4EA1 (20129)
{
...
int func_96(eCharacter echParam0, eCharacter echParam1) // Position - 0x5EF9 (24313)
{
...
void func_127(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, const char* sParam7, const char* sParam8, const char* sParam9, const char* sParam10, const char* sParam11) // Position - 0x6A6C (27244)
{
