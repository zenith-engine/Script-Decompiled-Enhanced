...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7984 (31108)
{
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x92BF (37567)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x92D5 (37589)
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x932D (37677)
{
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xC0D7 (49367)
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
int func_223(Ped pedParam0, int iParam1, ePedComponentType epctParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xDE48 (56904)
{
	...
	if (iParam5 == 0)
	{
		Global_79347[1 /*14*/] = { func_272(entityModel, iParam1, epctParam2, -1) };
...
BOOL func_225(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0xE6FA (59130)
{
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79347[1 /*14*/] = { func_272(entityModel, epctParam1, epctParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_225(pedParam0, i, unk[i]))
				{
								...
								for (k = 0; k <= 19; k = k + 1)
								{
									...
									if (Global_79347[2 /*14*/].f_12 == j)
										if (func_225(pedParam0, 14, k))
											if (!func_230(entityModel, epctParam2, 14, k, &unk, &Global_79347[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79347[2 /*14*/] = { func_272(entityModel, i, type, -1) };
					
						if (!func_230(entityModel, epctParam2, i, type, &unk, &Global_79347[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79347[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_234(epctParam1)) && Global_79347[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_234(epctParam1)))
	{
		return true;
	}
...
{
	Global_79347[1 /*14*/] = { func_272(hParam0, iParam1, epctParam2, -1) };
...
void func_244(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, ePedComponentType epctParam3) // Position - 0x10F29 (69417)
{
	...
	else
	{
		...
		if (epctParam1 == PV_COMP_HEAD)
		{
			...
			if (func_245(ENTITY::GET_ENTITY_MODEL(pedParam0), 14, type, FILES::GET_HASH_NAME_FOR_PROP(pedParam0, 0, epctParam2, epctParam3)))
			{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (epctParam2 >= 327)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_246(hParam0, epctParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (epctParam2 >= 26)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_246(hParam0, epctParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (epctParam2 >= 327)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_246(hParam0, epctParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (epctParam2 >= 26)
					{
						...
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_246(hParam0, epctParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
struct<14> func_272(Hash hParam0, int iParam1, ePedComponentType epctParam2, int iParam3) // Position - 0x18C19 (101401)
{
	func_335();
...
BOOL func_279(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1AF6F (110447)
{
	int num;
	int num2;
	int num3;
				...
				case joaat("Player_One"):
					switch (iParam1)
					{
						case 3:
							...
							{
								type = 227 + Global_79347[1 /*14*/].f_4;
						...
						case 11:
							if (epctParam2 >= PV_COMP_TASK && epctParam2 <= 24)
							{
								type = 25 + Global_79347[1 /*14*/].f_4;
								func_336(hParam0, 11, type, true, 0);
							}
							else if (epctParam2 >= 25 && epctParam2 <= 40)
							{
								type = 9 + Global_79347[1 /*14*/].f_4;
								func_336(hParam0, 11, type, true, 0);
							}
							break;
						...
						case 8:
							...
							{
								type = 43 + Global_79347[1 /*14*/].f_4;
								func_336(hParam0, 8, type, true, 0);
								type = 59 + Global_79347[1 /*14*/].f_4;
								func_336(hParam0, 8, type, true, 0);
							}
							else if (epctParam2 >= 43 && epctParam2 <= 58)
							{
								type = 27 + Global_79347[1 /*14*/].f_4;
								func_336(hParam0, 8, type, true, 0);
								type = 59 + Global_79347[1 /*14*/].f_4;
								func_336(hParam0, 8, type, true, 0);
							}
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x2EA66 (191078)
{
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0x338F1 (211185)
{
	var unk;
...
char* func_479(char* sParam0) // Position - 0x38C77 (232567)
{
	return sParam0;
}
