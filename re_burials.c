...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x11DE (4574)
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x1311 (4881)
{
...
void func_86(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x4484 (17540)
{
...
eCharacter func_102(int iParam0, BOOL bParam1) // Position - 0x524B (21067)
{
	eCharacter character;
	int num;
