...
{
	if (Global_1836642 == PV_COMP_HEAD || Global_1836642 == PV_COMP_HAIR)
		iLocal_18 = 3;
...
int _GET_LOBBY_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer, BOOL includeSpectators) // Position - 0x3D76 (15734)
{
	int address;
	int i;
...
BOOL func_26(ePedComponentType epctParam0, int iParam1) // Position - 0x3DDB (15835)
{
	BOOL flag;
...
BOOL func_29(ePedComponentType epctParam0) // Position - 0x3E81 (16001)
{
	Player player;
...
BOOL _NETWORK_IS_PLAYER_VALID(ePedComponentType player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x3EA3 (16035)
{
	ePedComponentType type;
...
BOOL func_51(Vehicle veParam0, Any* panParam1) // Position - 0xAA8F (43663)
{
	...
	{
		type = Global_2359296[func_58() /*5571*/].f_681.f_2;
	
		if (type > PV_COMP_INVALID && type < 547)
			if (IS_BIT_SET(Global_1586543[type /*143*/].f_104, 8))
				flag = true;
	}
...
ePedComponentType func_57(Player plParam0) // Position - 0xAFEA (45034)
{
	if (func_29(plParam0))
		if (func_56(plParam0, false))
...
int func_61(Player plParam0, BOOL bParam1, int iParam2) // Position - 0xB046 (45126)
{
	...
	if (func_29(type) && Global_1887694[type /*611*/].f_10.f_431 == iParam2)
		return 1;

	return 0;
}

BOOL func_62(ePedComponentType epctParam0, int iParam1) // Position - 0xB0A2 (45218)
{
	if (func_29(epctParam0))
		if (func_29(Global_1887694[epctParam0 /*611*/].f_10))
...
BOOL func_68(ePedComponentType epctParam0) // Position - 0xB1AD (45485)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		if (func_69(epctParam0) && Global_2657994[epctParam0 /*467*/].f_324.f_11 == epctParam0)
			return true;

	return false;
}

BOOL func_69(ePedComponentType epctParam0) // Position - 0xB1E2 (45538)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
			if (Global_2657994[epctParam0 /*467*/].f_324.f_8 != PV_COMP_INVALID)
				return func_70(Global_2657994[epctParam0 /*467*/].f_324.f_8) == 22;

	return false;
}

int func_70(ePedComponentType epctParam0) // Position - 0xB229 (45609)
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_88(ePedComponentType epctParam0) // Position - 0xCEC8 (52936)
{
	ePedComponentType type;
...
BOOL func_89(ePedComponentType epctParam0) // Position - 0xCEEC (52972)
{
	ePedComponentType type;
	...
	if (type != PV_COMP_INVALID)
		return func_90(epctParam0, 9);

	return false;
}

BOOL func_90(ePedComponentType epctParam0, int iParam1) // Position - 0xCF0A (53002)
{
...
ePedComponentType func_97(Vehicle veParam0, int iParam1) // Position - 0xD387 (54151)
{
	ePedComponentType i;
...
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("fm_mission_creator")) == 0 || Global_1836642 == PV_COMP_HEAD)
		iLocal_18 = 3;
