...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x2046 (8262)
{
...
BOOL func_79(ePedComponentType epctParam0) // Position - 0x440A (17418)
{
...
BOOL _NETWORK_IS_PLAYER_VALID(ePedComponentType player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x4470 (17520)
{
	ePedComponentType type;
...
int func_116(Vehicle veParam0, int iParam1, eCharacter echParam2) // Position - 0x59D5 (22997)
{
	var script;
...
void func_117(Vehicle veParam0, eCharacter echParam1) // Position - 0x5A15 (23061)
{
	Ped pedInVehicleSeat;
	int i;
	int j;
...
BOOL func_128(ePedComponentType epctParam0, int iParam1) // Position - 0x6738 (26424)
{
	int cloudTimeAsInt;
	int num;
	int i;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x6965 (26981)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x697B (27003)
{
...
eCharacter func_140(Vehicle veParam0) // Position - 0x6C63 (27747)
{
	int i;
