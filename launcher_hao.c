...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x762F (30255)
{
...
ePedComponentType func_83() // Position - 0x7659 (30297)
{
...
BOOL func_86(ePedComponentType epctParam0) // Position - 0x769D (30365)
{
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x8557 (34135)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8F6A (36714)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8F80 (36736)
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8FD8 (36824)
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB525 (46373)
{
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBE2A (48682)
{
	if (Global_101713 == 10 || Global_101713 == 9)
		return true;
...
void func_197(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD09F (53407)
{
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD930 (55600)
{
	var unk;
	...
	if (func_247(*panParam0) || func_245(*panParam0) || Global_79810 == true)
		return true;
...
int func_255(Ped pedParam0, eCharacter echParam1) // Position - 0xF593 (62867)
{
	int num;
...
BOOL func_257(eCharacter echParam0) // Position - 0xF60A (62986)
{
	int i;
