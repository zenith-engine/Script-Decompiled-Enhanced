...
BOOL func_35(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x46C5 (18117)
{
	...
	if (Global_114162.f_7692.f_866 < CHAR_STEVE_MIKE_CONF)
	{
		num = iParam0;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x4AB3 (19123)
{
...
int func_63(Ped pedParam0, int iParam1, ePedComponentType epctParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x5280 (21120)
{
	int i;
	int j;
	int k;
	...
	if (iParam5 == 0)
	{
		Global_79347[1 /*14*/] = { func_115(entityModel, iParam1, epctParam2, -1) };
...
void func_66(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x5B6D (23405)
{
	ePedComponentType type;
	int num;
...
BOOL func_67(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x5BF7 (23543)
{
	if (hParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_68(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x5CD5 (23765)
{
	Global_79347[1 /*14*/] = { func_115(hParam0, iParam1, epctParam2, -1) };
	return IS_BIT_SET(Global_79347[1 /*14*/].f_6, 2);
}

BOOL func_69(Hash hParam0, ePedComponentType epctParam1, int iParam2, ePedComponentType epctParam3, var uParam4, int iParam5) // Position - 0x5CFD (23805)
{
	var unk;
	int i;
...
BOOL func_70(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x6301 (25345)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
ePedComponentType func_72(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x6445 (25669)
{
	ePedComponentType i;
	ePedComponentType j;
...
int func_74(Hash hParam0, int iParam1, ePedComponentType epctParam2, var uParam3) // Position - 0x6596 (26006)
{
	int num;
...
ePedComponentType func_75(Ped pedParam0, Hash hParam1, int iParam2, ePedComponentType epctParam3, int iParam4, int iParam5) // Position - 0x689D (26781)
{
	ePedComponentType type;
	ePedComponentType type2;
	ePedComponentType type3;
...
BOOL func_76(int iParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, ePedComponentType epctParam3, var uParam4) // Position - 0x7450 (29776)
{
	int num;
...
ePedComponentType func_77(Hash hParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, int iParam3) // Position - 0x7734 (30516)
{
	int num;
...
ePedComponentType func_78(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x79FB (31227)
{
	ePedComponentType i;
	ePedComponentType type;
...
BOOL func_79(Ped pedParam0, int iParam1, ePedComponentType epctParam2, ePedComponentType epctParam3) // Position - 0x7A32 (31282)
{
	ePedComponentType type;
...
BOOL func_80(Hash hParam0, ePedComponentType epctParam1, var uParam2) // Position - 0x7A5B (31323)
{
	*uParam2 = -99;
...
int func_81(Hash hParam0, int iParam1, ePedComponentType epctParam2, var uParam3) // Position - 0x7D25 (32037)
{
	int num;
...
ePedComponentType func_82(Hash hParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x7FAF (32687)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_84(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x81A2 (33186)
{
	switch (hParam0)
	{
...
Hash func_85(Hash hParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x8270 (33392)
{
	var outProp;
	int componentId;
	int num;
...
ePedComponentType func_88(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x8792 (34706)
{
	Hash entityModel;
...
struct<10> func_93(Hash hParam0, ePedComponentType epctParam1) // Position - 0x8B6C (35692)
{
	int i;
	var unk;
...
struct<17> func_96(Hash hParam0, ePedComponentType epctParam1) // Position - 0x960D (38413)
{
	int i;
	var unk;
...
void func_99(var uParam0, int iParam1, int iParam2, ePedComponentType epctParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xB6EF (46831)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
...
BOOL func_100(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0xB760 (46944)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_101(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0xB9DD (47581)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_102(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0xBE02 (48642)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
ePedComponentType func_103(Ped pedParam0, ePedComponentType epctParam1) // Position - 0xC0F6 (49398)
{
	int pedPropIndex;
...
ePedComponentType func_104(Ped pedParam0, int iParam1) // Position - 0xC13D (49469)
{
...
struct<14> func_115(Hash hParam0, int iParam1, ePedComponentType epctParam2, int iParam3) // Position - 0xFE9C (65180)
{
	func_178();
...
void func_116(int iParam0, ePedComponentType epctParam1) // Position - 0xFEEE (65262)
{
	switch (iParam0)
	{
		case 0:
...
void func_136(ePedComponentType epctParam0) // Position - 0x14B31 (84785)
{
	if (epctParam0 < 136)
		func_138(epctParam0);
	else
...
void func_141(int iParam0, ePedComponentType epctParam1) // Position - 0x1688E (92302)
{
	switch (iParam0)
	{
		case 0:
...
void func_154(ePedComponentType epctParam0) // Position - 0x1B7E2 (112610)
{
	if (epctParam0 < 107)
		func_157(epctParam0);
...
void func_160(int iParam0, ePedComponentType epctParam1) // Position - 0x1E0AD (123053)
{
	switch (iParam0)
	{
		case 0:
...
void func_173(ePedComponentType epctParam0) // Position - 0x21F45 (139077)
{
	if (epctParam0 < 60)
		func_175(epctParam0);
	else
...
BOOL func_179(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x235E4 (144868)
{
	Hash entityModel;
	ePedComponentType type;
	int i;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79347[1 /*14*/] = { func_115(entityModel, epctParam1, epctParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_179(pedParam0, i, unk[i]))
				{
								...
								for (k = 0; k <= 19; k = k + 1)
								{
									...
									if (Global_79347[2 /*14*/].f_12 == j)
										if (func_179(pedParam0, 14, k))
											if (!func_69(entityModel, epctParam2, 14, k, &unk, &Global_79347[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79347[2 /*14*/] = { func_115(entityModel, i, type, -1) };
					
						if (!func_69(entityModel, epctParam2, i, type, &unk, &Global_79347[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79347[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_73(epctParam1)) && Global_79347[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_73(epctParam1)))
	{
		return true;
	}
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x23C9B (146587)
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x262D3 (156371)
{
...
char* func_250(char* sParam0) // Position - 0x2A1E1 (172513)
{
	return sParam0;
}
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0x2ADE6 (175590)
{
...
void func_276(int iParam0) // Position - 0x2BC75 (179317)
{
	int i;
	int j;
...
BOOL func_286(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x2C566 (181606)
{
	Hash entityModel;
	int i;
	var unk;
...
void func_289(int iParam0, BOOL bParam1) // Position - 0x2C7BA (182202)
{
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x2C9C7 (182727)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x2C9DD (182749)
{
...
int func_339(const char* sParam0) // Position - 0x32542 (206146)
{
...
int func_341(const char* sParam0, BOOL bParam1) // Position - 0x325C0 (206272)
{
	Hash hashKey;
	int num;
