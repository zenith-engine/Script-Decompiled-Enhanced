...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xC45 (3141)
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xDAD (3501)
{
...
BOOL func_123(ePedComponentType epctParam0) // Position - 0x4843 (18499)
{
...
BOOL _NETWORK_IS_PLAYER_VALID(ePedComponentType player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x48A9 (18601)
{
