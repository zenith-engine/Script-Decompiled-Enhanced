...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xD5D (3421)
{
...
void func_80(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2CA9 (11433)
{
...
void func_118(int iParam0, int iParam1) // Position - 0x46E3 (18147)
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x73C3 (29635)
{
