...
void _CONTEXT_REMOVE_HELP_TEXT(var uParam0) // Position - 0x16E9 (5865)
{
	int num;
...
int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x2AF4 (10996)
{
	int i;
