...
void func_6() // Position - 0x342 (834)
{
	if (Global_114162.f_14145[iLocal_56 /*104*/].f_24 == 1)
	{
		if (Global_21061 == false)
		{
			if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, Global_21054))
			{
				...
				{
					Global_114162.f_14145[iLocal_56 /*104*/].f_99[0] = false;
					Global_114162.f_14145[iLocal_56 /*104*/].f_99[1] = false;
					Global_114162.f_14145[iLocal_56 /*104*/].f_99[2] = false;
				}
				else
				{
					Global_114162.f_14145[iLocal_56 /*104*/].f_99[Global_21083] = false;
				}
	...
	if (Global_21061 == false && iLocal_62 == 1)
	{
...
void func_10(char* sParam0) // Position - 0xE3D (3645)
{
...
BOOL func_29(Hash hParam0) // Position - 0x149A (5274)
{
	int i;
...
int func_40(eCharacter echParam0, eCharacter echParam1) // Position - 0x1C24 (7204)
{
	...
	for (i = 0; i < 34; i = i + 1)
	{
		...
		while (num < 35)
		{
			...
			if (unk[num] == 0)
			{
				...
				{
					if (Global_114162.f_14145[num /*104*/].f_99[Global_21083] == true)
					{
		...
		{
			if (Global_114162.f_14145[num2 /*104*/].f_99[Global_21083] == true)
			{
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_21064, "SET_DATA_SLOT");
		...
		if (Global_114162.f_14145[i /*104*/].f_24 != 0)
			if (Global_114162.f_14145[i /*104*/].f_99[Global_21083] == true)
