...
void func_39(BOOL bParam0) // Position - 0x46E9 (18153)
{
...
void _STOPWATCH_DESTROY(int iParam0) // Position - 0x6F3E (28478)
{
	iParam0->f_1 = 0;
	return;
}
...
void func_114(int iParam0) // Position - 0x745F (29791)
{
	int i;
...
void func_120(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, const char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15) // Position - 0x774B (30539)
{
	int num;
	int i;
...
BOOL _STOPWATCH_HAS_TIME_PASSED(int pStopwatch, int millis, BOOL useLocalTimer) // Position - 0xB300 (45824)
{
	if (millis == -1)
		return true;
...
void _STOPWATCH_INITIALIZE(int pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0xB35E (45918)
{
	if (pStopwatch->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
...
BOOL IS_XBOX_PLATFORM() // Position - 0xBB5A (47962)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL IS_PLAYSTATION_PLATFORM() // Position - 0xBB70 (47984)
{
...
BOOL _STOPWATCH_IS_INITIALIZED(int iParam0) // Position - 0xEFC4 (61380)
{
	return iParam0->f_1;
}
...
void _STOPWATCH_RESET(int pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0xF522 (62754)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
		if (!useAccurateTime)
			*pStopwatch = NETWORK::GET_NETWORK_TIME();
...
BOOL _LEADERBOARDS2_TRY_BEGIN_WRITE_DATA(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x10548 (66888)
{
	int num;
	int i;
	var gamerHandle;
...
void func_361(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x1B9C1 (113089)
{
	...
	if (bParam3)
	{
		...
		{
			func_390(Global_23987.f_5821 + 1, "DFLT_MNU_OPT" /*Exit*/, 0, true, false, false, false);
		...
		if (i == 1 || !Global_23987.f_6331)
		{
			...
			for (j = PV_COMP_HEAD; j <= type; j = j + 1)
			{
				...
				if (flag && i == 1 && flag2)
				{
					...
					func_388("CommonMenu", "Gradient_Nav", Global_23984 + (iParam5 * 0.5f), num40 + num44 + (0.00277776f * (float)num5) + (num37 * 0.5f), iParam5, num37, 0f, r2, g2, b2, a2, false, 0);
								...
								if (flag2)
								{
									if (!Global_23987.f_6332)
									{
										...
										if (MISC::GET_HASH_KEY(&Global_23987.f_79[num16 /*6*/]) != 0)
										{
											...
											func_373(flag, Global_23987.f_1616[num16], Global_23987.f_1873[num16], flag7, num45, flag5, flag4);
...
void func_367(float fParam0, float fParam1, char* sParam2, BOOL bParam3, int iParam4) // Position - 0x1EC47 (126023)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
void func_390(ePedComponentType epctParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1FA7E (129662)
{
	int num;
	float num2;
	float num3;
...
void func_393(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x1FCF3 (130291)
{
	int num;
...
BOOL func_394(BOOL bParam0, BOOL bParam1) // Position - 0x1FD3F (130367)
{
	...
	if (!CAM::IS_SCREEN_FADED_IN() || func_396(8, -1) && func_395() != TRANSITION_STATE_WAITING_FOR_EXTERNAL_TERMINATION_CALL || HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1 || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0 || NETWORK::IS_COMMERCE_STORE_OPEN() || Global_79825 || Global_23987.f_9115 || HUD::IS_WARNING_MESSAGE_ACTIVE() || Global_101765.f_1490)
		return false;

	return true;
}

eTransitionState func_395() // Position - 0x1FDDC (130524)
{
...
BOOL func_397(int iParam0, BOOL bParam1) // Position - 0x1FE20 (130592)
{
	if (bParam1)
	{
		switch (iParam0)
...
int func_398(int* piParam0, ePedComponentType epctParam1, int iParam2) // Position - 0x1FEA7 (130727)
{
	if (!PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
		return 0;
	...
	if (func_419(0) == 1 && Global_4542450 == epctParam1)
	{
		if (!func_444(piParam0))
		{
			func_399(piParam0);
...
void func_404(int iParam0, eHudColour ehcParam1, eHudColour ehcParam2, int iParam3) // Position - 0x2017E (131454)
{
	Global_23987.f_9112 = iParam3;
	Global_23987.f_9109[0] = ehcParam1;
	Global_23987.f_9109[1] = ehcParam2;
	Global_23987.f_9113 = iParam0;
	return;
}

void func_405(ePedComponentType epctParam0, BOOL bParam1, BOOL bParam2) // Position - 0x201AC (131500)
{
	int num;
	float num2;
	float num3;
...
float func_406(char* sParam0, BOOL bParam1) // Position - 0x2032B (131883)
{
	!HUD::DOES_TEXT_LABEL_EXIST(sParam0);
	bParam1 == false;
	return HUD::GET_RENDERED_CHARACTER_HEIGHT(0.35f, 0);
...
float func_407(char* sParam0, BOOL bParam1) // Position - 0x2034D (131917)
{
...
void func_408(BOOL bParam0, char* sParam1, char* sParam2) // Position - 0x2037F (131967)
{
...
int func_415(int* piParam0, ePedComponentType epctParam1, int iParam2) // Position - 0x2055D (132445)
{
	if (!PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
		return 0;
...
BOOL func_475(int* piParam0) // Position - 0x224AB (140459)
{
	switch (piParam0->f_9)
	{
		case 0:
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x226F7 (141047)
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x23051 (143441)
{
