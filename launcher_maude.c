...
ePedComponentType func_83() // Position - 0x7577 (30071)
{
...
BOOL func_86(ePedComponentType epctParam0) // Position - 0x75BB (30139)
{
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x8475 (33909)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
int func_247(Ped pedParam0, eCharacter echParam1) // Position - 0xEFE9 (61417)
{
	int num;
