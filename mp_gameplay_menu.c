...
void func_8(int* piParam0) // Position - 0x701 (1793)
{
	if (piParam0->f_9 != 0)
	{
...
BOOL func_43(BOOL bParam0, BOOL bParam1) // Position - 0x15BF (5567)
{
	...
	if (!CAM::IS_SCREEN_FADED_IN() || func_45(8, -1) && func_44() != TRANSITION_STATE_WAITING_FOR_EXTERNAL_TERMINATION_CALL || HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1 || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0 || NETWORK::IS_COMMERCE_STORE_OPEN() || Global_79825 || Global_23987.f_9115 || HUD::IS_WARNING_MESSAGE_ACTIVE() || Global_101765.f_1490)
		return false;

	return true;
}

eTransitionState func_44() // Position - 0x165C (5724)
{
...
void func_46(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x16A0 (5792)
{
	...
	if (bParam3)
	{
		...
		{
			func_93(Global_23987.f_5821 + 1, "DFLT_MNU_OPT" /*Exit*/, 0, true, false, false, false);
		...
		if (i == 1 || !Global_23987.f_6331)
		{
			...
			for (j = PV_COMP_HEAD; j <= type; j = j + 1)
			{
				...
				if (flag && i == 1 && flag2)
				{
					...
					func_78("CommonMenu", "Gradient_Nav", Global_23984 + (iParam5 * 0.5f), num40 + num44 + (0.00277776f * (float)num5) + (num37 * 0.5f), iParam5, num37, 0f, r2, g2, b2, a2, false, 0);
								...
								if (flag2)
								{
									if (!Global_23987.f_6332)
									{
										...
										if (MISC::GET_HASH_KEY(&Global_23987.f_79[num16 /*6*/]) != 0)
										{
											...
											func_62(flag, Global_23987.f_1616[num16], Global_23987.f_1873[num16], flag7, num45, flag5, flag4);
										...
										else
										{
											...
											if (IS_ROCKSTAR_DEV() && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("fm_mission_creator")) > 0)
											{
												if (k == 0)
												{
													...
													func_76(num24 - num48, num25 + num47, 0);
													num22 = num22 + 1;
												}
											}
										}
...
void func_56(float fParam0, float fParam1, char* sParam2, ePedComponentType epctParam3, int iParam4) // Position - 0x4AA5 (19109)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
BOOL func_66(Player plParam0, int iParam1) // Position - 0x54A3 (21667)
{
	...
	if (plParam0 == PLAYER::PLAYER_ID())
		flag = func_67(-1, false) == CHAR_MIKE_FRANK_CONF;
	else
...
eCharacter func_67(int iParam0, BOOL bParam1) // Position - 0x54FC (21756)
{
...
void func_90(ePedComponentType epctParam0, int iParam1, BOOL bParam2) // Position - 0x6187 (24967)
{
	int num;
	float num2;
	float num3;
...
BOOL func_91(ePedComponentType epctParam0) // Position - 0x6302 (25346)
{
	return func_92(&(hLocal_843.f_2), epctParam0);
}

BOOL func_92(var uParam0, ePedComponentType epctParam1) // Position - 0x6315 (25365)
{
	return IS_BIT_SET(uParam0->[epctParam1 / 32], epctParam1 & 31);
}

void func_93(ePedComponentType epctParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x632C (25388)
{
	int num;
	float num2;
	float num3;
...
void func_96(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x65A1 (26017)
{
	int num;
...
BOOL func_97(ePedComponentType epctParam0) // Position - 0x65ED (26093)
{
	if (IS_BIT_SET(hLocal_724.f_2.f_104[epctParam0], 7))
		if (!IS_BIT_SET(hLocal_724.f_2.f_104[epctParam0], 2))
			return true;

	return func_98(&(hLocal_724.f_2), epctParam0);
}

BOOL func_98(var uParam0, ePedComponentType epctParam1) // Position - 0x6625 (26149)
{
...
void func_106() // Position - 0x683B (26683)
{
	...
	type = Global_23987.f_6342;

	if (type <= PV_COMP_INVALID || type >= PV_COMP_MAX)
		return;

	if (func_10(2) && func_98(&(hLocal_724.f_2), type))
	{
		if (func_91(type))
			func_111(type);
		else
...
void func_109(ePedComponentType epctParam0) // Position - 0x68DD (26845)
{
	func_110(&(hLocal_843.f_2), epctParam0);
	return;
}

void func_110(var uParam0, ePedComponentType epctParam1) // Position - 0x68F0 (26864)
{
	MISC::SET_BIT(&uParam0->[epctParam1 / 32], epctParam1 & 31);
	return;
}

void func_111(ePedComponentType epctParam0) // Position - 0x690A (26890)
{
	func_112(&(hLocal_843.f_2), epctParam0);
	return;
}

void func_112(var uParam0, ePedComponentType epctParam1) // Position - 0x691D (26909)
{
...
BOOL func_119(int* piParam0) // Position - 0x6ECA (28362)
{
	switch (piParam0->f_9)
	{
		case 0:
...
void func_121() // Position - 0x6F86 (28550)
{
	...
	for (i = 0; i <= 11; i = i + 1)
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&hLocal_724.f_2.f_6[i /*4*/]))
		{
			...
			if (func_97(i) && iLocal_19.f_2 == -1 && Global_1919829 == PV_COMP_INVALID)
			{
				func_114(i, false, 1);
				iLocal_19.f_2 = i;
			}
	...
	if (Global_1919829 != PV_COMP_INVALID && func_97(Global_1919829))
	{
